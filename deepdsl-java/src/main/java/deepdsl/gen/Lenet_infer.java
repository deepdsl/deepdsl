...
// val X68 = Convolv(1,0)(X67,cv1_W,cv1_B)
JCudaTensor x7;
...
// val X69 = Pooling(2,2,0,true)(X68)
JCudaTensor x15;
JCudaTensor x16;
x16 = x7;
x15 = x17.forward(x16);
...
// val X70 = Convolv(1,0)(X69,cv2_W,cv2_B)
JCudaTensor x19;
...
// val X71 = Pooling(2,2,0,true)(X70)
JCudaTensor x27;
JCudaTensor x28;
x28 = x19;
x27 = x29.forward(x28);
