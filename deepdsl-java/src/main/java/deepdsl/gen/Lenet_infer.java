...
// val X157 = Convolv(1,0)(X156,cv1_W,cv1_B)
JCudaTensor x7;
...
// val X158 = Pooling(2,2,0,true)(X157)
JCudaTensor x15;
JCudaTensor x16;
x16 = x7;
x15 = x17.forward(x16);
...
// val X159 = Convolv(1,0)(X158,cv2_W,cv2_B)
JCudaTensor x19;
...
// val X160 = Pooling(2,2,0,true)(X159)
JCudaTensor x27;
JCudaTensor x28;
x28 = x19;
x27 = x29.forward(x28);
...
// val X161 = (X160[1><3])(i10 | @) * (fc1_W)(i11 | @)
JCudaTensor x31;
JCudaMatrix x32;
JCudaMatrix x33;
JCudaTensor x34;
