...
public class Lenet_tanh {
	...
	static void train() {
		for(int x5=0; x5<train_itr; x5++) {
			...
			x185 = x174;
			x186 = x7;
			x15.backward_filter(x185, x186, x13, x181, x182);
			...
			JCudaTensor x192;
			x192 = x174;
			x15.backward_bias(x192, x14, x188, x189);
	...
	static void test() {
		...
		System.out.println();
		System.out.println("average precision: " + x237/10);
		System.out.println(); 
	}
