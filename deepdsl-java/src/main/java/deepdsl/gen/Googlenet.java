...
public class Googlenet {
	...
	static void train() {
		for(int x5=0; x5<train_itr; x5++) {
			...
			// Cost(((((0 - (X227 . X226)) / |128|) + (((0 - (X227 . X239)) / |128|) * loss2)) + (((0 - (X227 . X252)) / |128|) * loss1)))
			float x967;
			float x968;
			float x969;
			float x970;
	...
	static void test() {
		for(int x5=0; x5<test_itr; x5++) {
			...
			x3083 = 128;
			x3081 = x3082 / x3083;
			System.out.println(x5 + " test precision "  + x3081);
			x3080 += x3081;
		...
		System.out.println();
		System.out.println("average precision: " + x3080/10);
		System.out.println(); 
	}
