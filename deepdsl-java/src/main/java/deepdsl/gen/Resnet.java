...
public class Resnet {
	...
	static JCudnnBatchNorm x454 = new JCudnnBatchNorm(network_dir + "/4a1_bn", new int[]{64,1024,14,14});
	// (BatchNorm(4a2_a_bn),List(List(64, 256, 14, 14), List(1, 256, 1, 1), List(1, 256, 1, 1)))
	static JCudnnBatchNorm x447 = new JCudnnBatchNorm(network_dir + "/4a2_a_bn", new int[]{64,256,14,14});
	...
	static JCudnnConvolution x218 = new JCudnnConvolution(new int[]{64,256,55,55},new int[]{128,256,1,1},new int[]{128}, 2, 0);
	// (Convolv(2,0),List(List(64, 256, 55, 55), List(512, 256, 1, 1), List(512)))
	static JCudnnConvolution x211 = new JCudnnConvolution(new int[]{64,256,55,55},new int[]{512,256,1,1},new int[]{512}, 2, 0);
	...
	// 3a1_cv_B
	static JCudaTensor x210 = JTensor.constFloat(0.0f, 512).asJCudaTensor();
	// 3a1_cv_W
	static JCudaTensor x209 = JTensor.randomFloat(-0.088388346f, 0.088388346f, 512, 256, 1, 1).load(network_dir + "/3a1_cv_W").asJCudaTensor();
	// 3a2_a_bn_bias
	...
	// 3a2_a_cv_B
	static JCudaTensor x217 = JTensor.constFloat(0.0f, 128).asJCudaTensor();
	// 3a2_a_cv_W
	static JCudaTensor x216 = JTensor.randomFloat(-0.088388346f, 0.088388346f, 128, 256, 1, 1).load(network_dir + "/3a2_a_cv_W").asJCudaTensor();
	// 3a2_b_bn_bias
	...
	// 4a1_bn_bias
	static JCudaTensor x453 = JTensor.constFloat(0.0f, 1, 1024, 1, 1).load(network_dir + "/4a1_bn_bias").asJCudaTensor();
	// 4a1_bn_scale
	static JCudaTensor x452 = JTensor.constFloat(1.0f, 1, 1024, 1, 1).load(network_dir + "/4a1_bn_scale").asJCudaTensor();
	// 4a1_cv_B
	...
	// 4a2_a_bn_bias
	static JCudaTensor x446 = JTensor.constFloat(0.0f, 1, 256, 1, 1).load(network_dir + "/4a2_a_bn_bias").asJCudaTensor();
	// 4a2_a_bn_scale
	static JCudaTensor x445 = JTensor.constFloat(1.0f, 1, 256, 1, 1).load(network_dir + "/4a2_a_bn_scale").asJCudaTensor();
	// 4a2_a_cv_B
	...
	// V_2a1_bn_bias
	static JCudaTensor x4819 = JTensor.constFloat(0.0f, 1, 256, 1, 1).asJCudaTensor();
	// V_2a1_bn_scale
	static JCudaTensor x4855 = JTensor.constFloat(0.0f, 1, 256, 1, 1).asJCudaTensor();
	// V_2a1_cv_W
	static JCudaTensor x4812 = JTensor.constFloat(0.0f, 256, 64, 1, 1).asJCudaTensor();
	// V_2a2_a_bn_bias
	static JCudaTensor x5033 = JTensor.constFloat(0.0f, 1, 64, 1, 1).asJCudaTensor();
	// V_2a2_a_bn_scale
	...
	// V_2a2_c_bn_bias
	static JCudaTensor x4837 = JTensor.constFloat(0.0f, 1, 256, 1, 1).asJCudaTensor();
	// V_2a2_c_bn_scale
	static JCudaTensor x4844 = JTensor.constFloat(0.0f, 1, 256, 1, 1).asJCudaTensor();
	// V_2a2_c_cv_W
	...
	// V_2c_b_bn_bias
	static JCudaTensor x4397 = JTensor.constFloat(0.0f, 1, 64, 1, 1).asJCudaTensor();
	// V_2c_b_bn_scale
	...
	// V_2c_c_bn_scale
	static JCudaTensor x4321 = JTensor.constFloat(0.0f, 1, 256, 1, 1).asJCudaTensor();
	// V_2c_c_cv_W
	...
	// V_3a1_bn_scale
	static JCudaTensor x4055 = JTensor.constFloat(0.0f, 1, 512, 1, 1).asJCudaTensor();
	// V_3a1_cv_W
	...
	// V_3a2_c_bn_scale
	static JCudaTensor x4040 = JTensor.constFloat(0.0f, 1, 512, 1, 1).asJCudaTensor();
	// V_3a2_c_cv_W
	static JCudaTensor x4047 = JTensor.constFloat(0.0f, 512, 128, 1, 1).asJCudaTensor();
	// V_3b_a_bn_bias
	static JCudaTensor x3927 = JTensor.constFloat(0.0f, 1, 128, 1, 1).asJCudaTensor();
	// V_3b_a_bn_scale
	static JCudaTensor x3937 = JTensor.constFloat(0.0f, 1, 128, 1, 1).asJCudaTensor();
	// V_3b_a_cv_W
	...
	// V_3d_a_bn_scale
	static JCudaTensor x3465 = JTensor.constFloat(0.0f, 1, 128, 1, 1).asJCudaTensor();
	// V_3d_a_cv_W
	...
	// V_3d_c_bn_scale
	static JCudaTensor x3313 = JTensor.constFloat(0.0f, 1, 512, 1, 1).asJCudaTensor();
	// V_3d_c_cv_W
	static JCudaTensor x3320 = JTensor.constFloat(0.0f, 512, 128, 1, 1).asJCudaTensor();
	// V_4a1_bn_bias
	static JCudaTensor x3033 = JTensor.constFloat(0.0f, 1, 1024, 1, 1).asJCudaTensor();
	// V_4a1_bn_scale
	static JCudaTensor x3051 = JTensor.constFloat(0.0f, 1, 1024, 1, 1).asJCudaTensor();
	// V_4a1_cv_W
	...
	// V_4a2_c_bn_scale
	static JCudaTensor x3044 = JTensor.constFloat(0.0f, 1, 1024, 1, 1).asJCudaTensor();
	// V_4a2_c_cv_W
	static JCudaTensor x3026 = JTensor.constFloat(0.0f, 1024, 256, 1, 1).asJCudaTensor();
	// V_4b_a_bn_bias
	...
	// V_4c_b_bn_scale
	static JCudaTensor x2600 = JTensor.constFloat(0.0f, 1, 256, 1, 1).asJCudaTensor();
	// V_4c_b_cv_W
	...
	// V_4c_c_bn_scale
	static JCudaTensor x2524 = JTensor.constFloat(0.0f, 1, 1024, 1, 1).asJCudaTensor();
	// V_4c_c_cv_W
	static JCudaTensor x2531 = JTensor.constFloat(0.0f, 1024, 256, 1, 1).asJCudaTensor();
	// V_4d_a_bn_bias
	static JCudaTensor x2440 = JTensor.constFloat(0.0f, 1, 256, 1, 1).asJCudaTensor();
	// V_4d_a_bn_scale
	...
	// V_4e_a_bn_bias
	static JCudaTensor x2201 = JTensor.constFloat(0.0f, 1, 256, 1, 1).asJCudaTensor();
	// V_4e_a_bn_scale
	...
	// V_5a1_bn_bias
	static JCudaTensor x1543 = JTensor.constFloat(0.0f, 1, 2048, 1, 1).asJCudaTensor();
	// V_5a1_bn_scale
	static JCudaTensor x1558 = JTensor.constFloat(0.0f, 1, 2048, 1, 1).asJCudaTensor();
	// V_5a1_cv_W
	static JCudaTensor x1550 = JTensor.constFloat(0.0f, 2048, 1024, 1, 1).asJCudaTensor();
	// V_5a2_a_bn_bias
	...
	// V_5a2_c_bn_bias
	static JCudaTensor x1565 = JTensor.constFloat(0.0f, 1, 2048, 1, 1).asJCudaTensor();
	// V_5a2_c_bn_scale
	static JCudaTensor x1529 = JTensor.constFloat(0.0f, 1, 2048, 1, 1).asJCudaTensor();
	// V_5a2_c_cv_W
	static JCudaTensor x1522 = JTensor.constFloat(0.0f, 2048, 512, 1, 1).asJCudaTensor();
	// V_5b_a_bn_bias
	...
	// V_5b_b_bn_scale
	static JCudaTensor x1346 = JTensor.constFloat(0.0f, 1, 512, 1, 1).asJCudaTensor();
	// V_5b_b_cv_W
	...
	// V_5b_c_bn_scale
	static JCudaTensor x1274 = JTensor.constFloat(0.0f, 1, 2048, 1, 1).asJCudaTensor();
	// V_5b_c_cv_W
	...
	public static void main(String[] args){
		...
		x453.save(network_dir + "/4a1_bn_bias");
		x452.save(network_dir + "/4a1_bn_scale");
		x431.save(network_dir + "/4a1_cv_W");
		x446.save(network_dir + "/4a2_a_bn_bias");
		x445.save(network_dir + "/4a2_a_bn_scale");
	...
	static void train() {
		for(int x5=0; x5<train_itr; x5++) {
			...
			// val X8814 = Cuda(Indicator(Y, 1000))
			JCudaTensor x7;
			JTensorFloat x8;
			...
			// val X8617 = Convolv(2,3)(X8616,1_cv_W,1_cv_B)
			JCudaTensor x11;
			...
			// val X8618 = BatchNorm(1_bn)(X8617,1_bn_scale,1_bn_bias)
			JCudaTensor x21;
			...
			// val X8619 = ReLU()(X8618)
			JCudaTensor x28;
			JCudaTensor x29;
			x29 = x21;
			x28 = x30.forward(x29);

			// val X8620 = Pooling(3,2,0,true)(X8619)
			JCudaTensor x31;
			JCudaTensor x32;
			x32 = x28;
			x31 = x33.forward(x32);

			// val X8621 = Convolv(1,0)(X8620,2a1_cv_W,2a1_cv_B)
			JCudaTensor x34;
			...
			// val X8624 = Convolv(1,0)(X8620,2a2_a_cv_W,2a2_a_cv_B)
			JCudaTensor x41;
			...
			// val X8622 = BatchNorm(2a1_bn)(X8621,2a1_bn_scale,2a1_bn_bias)
			JCudaTensor x48;
			...
			// val X8625 = BatchNorm(2a2_a_bn)(X8624,2a2_a_bn_scale,2a2_a_bn_bias)
			JCudaTensor x55;
			...
			// val X8626 = ReLU()(X8625)
			JCudaTensor x62;
			JCudaTensor x63;
			x63 = x55;
			x62 = x64.forward(x63);

			// val X8627 = Convolv(1,1)(X8626,2a2_b_cv_W,2a2_b_cv_B)
			JCudaTensor x65;
			...
			// val X8628 = BatchNorm(2a2_b_bn)(X8627,2a2_b_bn_scale,2a2_b_bn_bias)
			JCudaTensor x72;
			...
			// val X8629 = ReLU()(X8628)
			JCudaTensor x79;
			JCudaTensor x80;
			x80 = x72;
			x79 = x64.forward(x80);

			// val X8630 = Convolv(1,0)(X8629,2a2_c_cv_W,2a2_c_cv_B)
			JCudaTensor x81;
			...
			// val X8631 = BatchNorm(2a2_c_bn)(X8630,2a2_c_bn_scale,2a2_c_bn_bias)
			JCudaTensor x87;
			...
			// val X8634 = ReLU()(X8633)
			JCudaTensor x102;
			JCudaTensor x103;
			x103 = x99;
			x102 = x96.forward(x103);

			// val X8635 = Convolv(1,0)(X8634,2b_a_cv_W,2b_a_cv_B)
			JCudaTensor x104;
			...
			// val X8636 = BatchNorm(2b_a_bn)(X8635,2b_a_bn_scale,2b_a_bn_bias)
			JCudaTensor x111;
			...
			// val X8637 = ReLU()(X8636)
			JCudaTensor x118;
			JCudaTensor x119;
			x119 = x111;
			x118 = x64.forward(x119);

			// val X8638 = Convolv(1,1)(X8637,2b_b_cv_W,2b_b_cv_B)
			JCudaTensor x120;
			...
			// val X8639 = BatchNorm(2b_b_bn)(X8638,2b_b_bn_scale,2b_b_bn_bias)
			JCudaTensor x126;
			...
			// val X8640 = ReLU()(X8639)
			JCudaTensor x133;
			JCudaTensor x134;
			x134 = x126;
			x133 = x64.forward(x134);

			// val X8641 = Convolv(1,0)(X8640,2b_c_cv_W,2b_c_cv_B)
			JCudaTensor x135;
			...
			// val X8642 = BatchNorm(2b_c_bn)(X8641,2b_c_bn_scale,2b_c_bn_bias)
			JCudaTensor x141;
			...
			// val X8645 = ReLU()(X8644)
			JCudaTensor x153;
			JCudaTensor x154;
			x154 = x150;
			x153 = x96.forward(x154);

			// val X8646 = Convolv(1,0)(X8645,2c_a_cv_W,2c_a_cv_B)
			JCudaTensor x155;
			...
			// val X8647 = BatchNorm(2c_a_bn)(X8646,2c_a_bn_scale,2c_a_bn_bias)
			JCudaTensor x161;
			...
			// val X8648 = ReLU()(X8647)
			JCudaTensor x168;
			JCudaTensor x169;
			x169 = x161;
			x168 = x64.forward(x169);

			// val X8649 = Convolv(1,1)(X8648,2c_b_cv_W,2c_b_cv_B)
			JCudaTensor x170;
			...
			// val X8650 = BatchNorm(2c_b_bn)(X8649,2c_b_bn_scale,2c_b_bn_bias)
			JCudaTensor x176;
			...
			// val X8651 = ReLU()(X8650)
			JCudaTensor x183;
			JCudaTensor x184;
			x184 = x176;
			x183 = x64.forward(x184);

			// val X8652 = Convolv(1,0)(X8651,2c_c_cv_W,2c_c_cv_B)
			JCudaTensor x185;
			...
			// val X8653 = BatchNorm(2c_c_bn)(X8652,2c_c_bn_scale,2c_c_bn_bias)
			JCudaTensor x191;
			...
			// val X8656 = ReLU()(X8655)
			JCudaTensor x203;
			JCudaTensor x204;
			x204 = x200;
			x203 = x96.forward(x204);

			// val X8657 = Convolv(2,0)(X8656,3a1_cv_W,3a1_cv_B)
			JCudaTensor x205;
			...
			// val X8660 = Convolv(2,0)(X8656,3a2_a_cv_W,3a2_a_cv_B)
			JCudaTensor x212;
			...
			// val X8658 = BatchNorm(3a1_bn)(X8657,3a1_bn_scale,3a1_bn_bias)
			JCudaTensor x219;
			...
			// val X8661 = BatchNorm(3a2_a_bn)(X8660,3a2_a_bn_scale,3a2_a_bn_bias)
			JCudaTensor x226;
			...
			// val X8662 = ReLU()(X8661)
			JCudaTensor x233;
			JCudaTensor x234;
			x234 = x226;
			x233 = x235.forward(x234);

			// val X8663 = Convolv(1,1)(X8662,3a2_b_cv_W,3a2_b_cv_B)
			JCudaTensor x236;
			...
			// val X8664 = BatchNorm(3a2_b_bn)(X8663,3a2_b_bn_scale,3a2_b_bn_bias)
			JCudaTensor x243;
			...
			// val X8665 = ReLU()(X8664)
			JCudaTensor x250;
			JCudaTensor x251;
			x251 = x243;
			x250 = x235.forward(x251);

			// val X8666 = Convolv(1,0)(X8665,3a2_c_cv_W,3a2_c_cv_B)
			JCudaTensor x252;
			...
			// val X8667 = BatchNorm(3a2_c_bn)(X8666,3a2_c_bn_scale,3a2_c_bn_bias)
			JCudaTensor x259;
			...
			// val X8670 = ReLU()(X8669)
			JCudaTensor x274;
			JCudaTensor x275;
			x275 = x271;
			x274 = x268.forward(x275);

			// val X8671 = Convolv(1,0)(X8670,3b_a_cv_W,3b_a_cv_B)
			JCudaTensor x276;
			...
			// val X8672 = BatchNorm(3b_a_bn)(X8671,3b_a_bn_scale,3b_a_bn_bias)
			JCudaTensor x283;
			...
			// val X8673 = ReLU()(X8672)
			JCudaTensor x290;
			JCudaTensor x291;
			x291 = x283;
			x290 = x235.forward(x291);

			// val X8674 = Convolv(1,1)(X8673,3b_b_cv_W,3b_b_cv_B)
			JCudaTensor x292;
			...
			// val X8675 = BatchNorm(3b_b_bn)(X8674,3b_b_bn_scale,3b_b_bn_bias)
			JCudaTensor x298;
			...
			// val X8676 = ReLU()(X8675)
			JCudaTensor x305;
			JCudaTensor x306;
			x306 = x298;
			x305 = x235.forward(x306);

			// val X8677 = Convolv(1,0)(X8676,3b_c_cv_W,3b_c_cv_B)
			JCudaTensor x307;
			...
			// val X8678 = BatchNorm(3b_c_bn)(X8677,3b_c_bn_scale,3b_c_bn_bias)
			JCudaTensor x313;
			...
			// val X8681 = ReLU()(X8680)
			JCudaTensor x325;
			JCudaTensor x326;
			x326 = x322;
			x325 = x268.forward(x326);

			// val X8682 = Convolv(1,0)(X8681,3c_a_cv_W,3c_a_cv_B)
			JCudaTensor x327;
			...
			// val X8683 = BatchNorm(3c_a_bn)(X8682,3c_a_bn_scale,3c_a_bn_bias)
			JCudaTensor x333;
			...
			// val X8684 = ReLU()(X8683)
			JCudaTensor x340;
			JCudaTensor x341;
			x341 = x333;
			x340 = x235.forward(x341);

			// val X8685 = Convolv(1,1)(X8684,3c_b_cv_W,3c_b_cv_B)
			JCudaTensor x342;
			...
			// val X8686 = BatchNorm(3c_b_bn)(X8685,3c_b_bn_scale,3c_b_bn_bias)
			JCudaTensor x348;
			...
			// val X8687 = ReLU()(X8686)
			JCudaTensor x355;
			JCudaTensor x356;
			x356 = x348;
			x355 = x235.forward(x356);

			// val X8688 = Convolv(1,0)(X8687,3c_c_cv_W,3c_c_cv_B)
			JCudaTensor x357;
			...
			// val X8689 = BatchNorm(3c_c_bn)(X8688,3c_c_bn_scale,3c_c_bn_bias)
			JCudaTensor x363;
			...
			// val X8692 = ReLU()(X8691)
			JCudaTensor x375;
			JCudaTensor x376;
			x376 = x372;
			x375 = x268.forward(x376);

			// val X8693 = Convolv(1,0)(X8692,3d_a_cv_W,3d_a_cv_B)
			JCudaTensor x377;
			...
			// val X8694 = BatchNorm(3d_a_bn)(X8693,3d_a_bn_scale,3d_a_bn_bias)
			JCudaTensor x383;
			...
			// val X8695 = ReLU()(X8694)
			JCudaTensor x390;
			JCudaTensor x391;
			x391 = x383;
			x390 = x235.forward(x391);

			// val X8696 = Convolv(1,1)(X8695,3d_b_cv_W,3d_b_cv_B)
			JCudaTensor x392;
			...
			// val X8697 = BatchNorm(3d_b_bn)(X8696,3d_b_bn_scale,3d_b_bn_bias)
			JCudaTensor x398;
			...
			// val X8698 = ReLU()(X8697)
			JCudaTensor x405;
			JCudaTensor x406;
			x406 = x398;
			x405 = x235.forward(x406);

			// val X8699 = Convolv(1,0)(X8698,3d_c_cv_W,3d_c_cv_B)
			JCudaTensor x407;
			...
			// val X8700 = BatchNorm(3d_c_bn)(X8699,3d_c_bn_scale,3d_c_bn_bias)
			JCudaTensor x413;
			...
			// val X8703 = ReLU()(X8702)
			JCudaTensor x425;
			JCudaTensor x426;
			x426 = x422;
			x425 = x268.forward(x426);

			// val X8704 = Convolv(2,0)(X8703,4a1_cv_W,4a1_cv_B)
			JCudaTensor x427;
			...
			// val X8707 = Convolv(2,0)(X8703,4a2_a_cv_W,4a2_a_cv_B)
			JCudaTensor x434;
			...
			// val X8708 = BatchNorm(4a2_a_bn)(X8707,4a2_a_bn_scale,4a2_a_bn_bias)
			JCudaTensor x441;
			...
			// val X8705 = BatchNorm(4a1_bn)(X8704,4a1_bn_scale,4a1_bn_bias)
			JCudaTensor x448;
			...
			// val X8709 = ReLU()(X8708)
			JCudaTensor x455;
			JCudaTensor x456;
			x456 = x441;
			x455 = x457.forward(x456);

			// val X8710 = Convolv(1,1)(X8709,4a2_b_cv_W,4a2_b_cv_B)
			JCudaTensor x458;
			...
			// val X8711 = BatchNorm(4a2_b_bn)(X8710,4a2_b_bn_scale,4a2_b_bn_bias)
			JCudaTensor x465;
			...
			// val X8712 = ReLU()(X8711)
			JCudaTensor x472;
			JCudaTensor x473;
			x473 = x465;
			x472 = x457.forward(x473);

			// val X8713 = Convolv(1,0)(X8712,4a2_c_cv_W,4a2_c_cv_B)
			JCudaTensor x474;
			...
			// val X8714 = BatchNorm(4a2_c_bn)(X8713,4a2_c_bn_scale,4a2_c_bn_bias)
			JCudaTensor x481;
			...
			// val X8717 = ReLU()(X8716)
			JCudaTensor x496;
			JCudaTensor x497;
			x497 = x493;
			x496 = x490.forward(x497);

			// val X8718 = Convolv(1,0)(X8717,4b_a_cv_W,4b_a_cv_B)
			JCudaTensor x498;
			...
			// val X8719 = BatchNorm(4b_a_bn)(X8718,4b_a_bn_scale,4b_a_bn_bias)
			JCudaTensor x505;
			...
			// val X8720 = ReLU()(X8719)
			JCudaTensor x512;
			JCudaTensor x513;
			x513 = x505;
			x512 = x457.forward(x513);

			// val X8721 = Convolv(1,1)(X8720,4b_b_cv_W,4b_b_cv_B)
			JCudaTensor x514;
			...
			// val X8722 = BatchNorm(4b_b_bn)(X8721,4b_b_bn_scale,4b_b_bn_bias)
			JCudaTensor x520;
			...
			// val X8723 = ReLU()(X8722)
			JCudaTensor x527;
			JCudaTensor x528;
			x528 = x520;
			x527 = x457.forward(x528);

			// val X8724 = Convolv(1,0)(X8723,4b_c_cv_W,4b_c_cv_B)
			JCudaTensor x529;
			...
			// val X8725 = BatchNorm(4b_c_bn)(X8724,4b_c_bn_scale,4b_c_bn_bias)
			JCudaTensor x535;
			...
			// val X8728 = ReLU()(X8727)
			JCudaTensor x547;
			JCudaTensor x548;
			x548 = x544;
			x547 = x490.forward(x548);

			// val X8729 = Convolv(1,0)(X8728,4c_a_cv_W,4c_a_cv_B)
			JCudaTensor x549;
			...
			// val X8730 = BatchNorm(4c_a_bn)(X8729,4c_a_bn_scale,4c_a_bn_bias)
			JCudaTensor x555;
			...
			// val X8731 = ReLU()(X8730)
			JCudaTensor x562;
			JCudaTensor x563;
			x563 = x555;
			x562 = x457.forward(x563);

			// val X8732 = Convolv(1,1)(X8731,4c_b_cv_W,4c_b_cv_B)
			JCudaTensor x564;
			...
			// val X8733 = BatchNorm(4c_b_bn)(X8732,4c_b_bn_scale,4c_b_bn_bias)
			JCudaTensor x570;
			...
			// val X8734 = ReLU()(X8733)
			JCudaTensor x577;
			JCudaTensor x578;
			x578 = x570;
			x577 = x457.forward(x578);

			// val X8735 = Convolv(1,0)(X8734,4c_c_cv_W,4c_c_cv_B)
			JCudaTensor x579;
			...
			// val X8736 = BatchNorm(4c_c_bn)(X8735,4c_c_bn_scale,4c_c_bn_bias)
			JCudaTensor x585;
			...
			// val X8739 = ReLU()(X8738)
			JCudaTensor x597;
			JCudaTensor x598;
			x598 = x594;
			x597 = x490.forward(x598);

			// val X8740 = Convolv(1,0)(X8739,4d_a_cv_W,4d_a_cv_B)
			JCudaTensor x599;
			...
			// val X8741 = BatchNorm(4d_a_bn)(X8740,4d_a_bn_scale,4d_a_bn_bias)
			JCudaTensor x605;
			...
			// val X8742 = ReLU()(X8741)
			JCudaTensor x612;
			JCudaTensor x613;
			x613 = x605;
			x612 = x457.forward(x613);

			// val X8743 = Convolv(1,1)(X8742,4d_b_cv_W,4d_b_cv_B)
			JCudaTensor x614;
			...
			// val X8744 = BatchNorm(4d_b_bn)(X8743,4d_b_bn_scale,4d_b_bn_bias)
			JCudaTensor x620;
			...
			// val X8745 = ReLU()(X8744)
			JCudaTensor x627;
			JCudaTensor x628;
			x628 = x620;
			x627 = x457.forward(x628);

			// val X8746 = Convolv(1,0)(X8745,4d_c_cv_W,4d_c_cv_B)
			JCudaTensor x629;
			...
			// val X8747 = BatchNorm(4d_c_bn)(X8746,4d_c_bn_scale,4d_c_bn_bias)
			JCudaTensor x635;
			...
			// val X8750 = ReLU()(X8749)
			JCudaTensor x647;
			JCudaTensor x648;
			x648 = x644;
			x647 = x490.forward(x648);

			// val X8751 = Convolv(1,0)(X8750,4e_a_cv_W,4e_a_cv_B)
			JCudaTensor x649;
			...
			// val X8752 = BatchNorm(4e_a_bn)(X8751,4e_a_bn_scale,4e_a_bn_bias)
			JCudaTensor x655;
			...
			// val X8753 = ReLU()(X8752)
			JCudaTensor x662;
			JCudaTensor x663;
			x663 = x655;
			x662 = x457.forward(x663);

			// val X8754 = Convolv(1,1)(X8753,4e_b_cv_W,4e_b_cv_B)
			JCudaTensor x664;
			...
			// val X8755 = BatchNorm(4e_b_bn)(X8754,4e_b_bn_scale,4e_b_bn_bias)
			JCudaTensor x670;
			...
			// val X8756 = ReLU()(X8755)
			JCudaTensor x677;
			JCudaTensor x678;
			x678 = x670;
			x677 = x457.forward(x678);

			// val X8757 = Convolv(1,0)(X8756,4e_c_cv_W,4e_c_cv_B)
			JCudaTensor x679;
			...
			// val X8758 = BatchNorm(4e_c_bn)(X8757,4e_c_bn_scale,4e_c_bn_bias)
			JCudaTensor x685;
			...
			// val X8761 = ReLU()(X8760)
			JCudaTensor x697;
			JCudaTensor x698;
			x698 = x694;
			x697 = x490.forward(x698);

			// val X8762 = Convolv(1,0)(X8761,4f_a_cv_W,4f_a_cv_B)
			JCudaTensor x699;
			...
			// val X8763 = BatchNorm(4f_a_bn)(X8762,4f_a_bn_scale,4f_a_bn_bias)
			JCudaTensor x705;
			...
			// val X8764 = ReLU()(X8763)
			JCudaTensor x712;
			JCudaTensor x713;
			x713 = x705;
			x712 = x457.forward(x713);

			// val X8765 = Convolv(1,1)(X8764,4f_b_cv_W,4f_b_cv_B)
			JCudaTensor x714;
			...
			// val X8766 = BatchNorm(4f_b_bn)(X8765,4f_b_bn_scale,4f_b_bn_bias)
			JCudaTensor x720;
			...
			// val X8767 = ReLU()(X8766)
			JCudaTensor x727;
			JCudaTensor x728;
			x728 = x720;
			x727 = x457.forward(x728);

			// val X8768 = Convolv(1,0)(X8767,4f_c_cv_W,4f_c_cv_B)
			JCudaTensor x729;
			...
			// val X8769 = BatchNorm(4f_c_bn)(X8768,4f_c_bn_scale,4f_c_bn_bias)
			JCudaTensor x735;
			...
			// val X8772 = ReLU()(X8771)
			JCudaTensor x747;
			JCudaTensor x748;
			x748 = x744;
			x747 = x490.forward(x748);

			// val X8773 = Convolv(2,0)(X8772,5a1_cv_W,5a1_cv_B)
			JCudaTensor x749;
			...
			// val X8776 = Convolv(2,0)(X8772,5a2_a_cv_W,5a2_a_cv_B)
			JCudaTensor x756;
			...
			// val X8774 = BatchNorm(5a1_bn)(X8773,5a1_bn_scale,5a1_bn_bias)
			JCudaTensor x763;
			...
			// val X8777 = BatchNorm(5a2_a_bn)(X8776,5a2_a_bn_scale,5a2_a_bn_bias)
			JCudaTensor x770;
			...
			// val X8778 = ReLU()(X8777)
			JCudaTensor x777;
			JCudaTensor x778;
			x778 = x770;
			x777 = x779.forward(x778);

			// val X8779 = Convolv(1,1)(X8778,5a2_b_cv_W,5a2_b_cv_B)
			JCudaTensor x780;
			...
			// val X8780 = BatchNorm(5a2_b_bn)(X8779,5a2_b_bn_scale,5a2_b_bn_bias)
			JCudaTensor x787;
			...
			// val X8781 = ReLU()(X8780)
			JCudaTensor x794;
			JCudaTensor x795;
			x795 = x787;
			x794 = x779.forward(x795);

			// val X8782 = Convolv(1,0)(X8781,5a2_c_cv_W,5a2_c_cv_B)
			JCudaTensor x796;
			...
			// val X8783 = BatchNorm(5a2_c_bn)(X8782,5a2_c_bn_scale,5a2_c_bn_bias)
			JCudaTensor x803;
			...
			// val X8786 = ReLU()(X8785)
			JCudaTensor x818;
			JCudaTensor x819;
			x819 = x815;
			x818 = x812.forward(x819);

			// val X8787 = Convolv(1,0)(X8786,5b_a_cv_W,5b_a_cv_B)
			JCudaTensor x820;
			...
			// val X8788 = BatchNorm(5b_a_bn)(X8787,5b_a_bn_scale,5b_a_bn_bias)
			JCudaTensor x827;
			...
			// val X8789 = ReLU()(X8788)
			JCudaTensor x834;
			JCudaTensor x835;
			x835 = x827;
			x834 = x779.forward(x835);

			// val X8790 = Convolv(1,1)(X8789,5b_b_cv_W,5b_b_cv_B)
			JCudaTensor x836;
			...
			// val X8791 = BatchNorm(5b_b_bn)(X8790,5b_b_bn_scale,5b_b_bn_bias)
			JCudaTensor x842;
			...
			// val X8792 = ReLU()(X8791)
			JCudaTensor x849;
			JCudaTensor x850;
			x850 = x842;
			x849 = x779.forward(x850);

			// val X8793 = Convolv(1,0)(X8792,5b_c_cv_W,5b_c_cv_B)
			JCudaTensor x851;
			...
			// val X8794 = BatchNorm(5b_c_bn)(X8793,5b_c_bn_scale,5b_c_bn_bias)
			JCudaTensor x857;
			...
			// val X8797 = ReLU()(X8796)
			JCudaTensor x869;
			JCudaTensor x870;
			x870 = x866;
			x869 = x812.forward(x870);

			// val X8798 = Convolv(1,0)(X8797,5c_a_cv_W,5c_a_cv_B)
			JCudaTensor x871;
			...
			// val X8799 = BatchNorm(5c_a_bn)(X8798,5c_a_bn_scale,5c_a_bn_bias)
			JCudaTensor x877;
			...
			// val X8800 = ReLU()(X8799)
			JCudaTensor x884;
			JCudaTensor x885;
			x885 = x877;
			x884 = x779.forward(x885);

			// val X8801 = Convolv(1,1)(X8800,5c_b_cv_W,5c_b_cv_B)
			JCudaTensor x886;
			...
			// val X8802 = BatchNorm(5c_b_bn)(X8801,5c_b_bn_scale,5c_b_bn_bias)
			JCudaTensor x892;
			...
			// val X8803 = ReLU()(X8802)
			JCudaTensor x899;
			JCudaTensor x900;
			x900 = x892;
			x899 = x779.forward(x900);

			// val X8804 = Convolv(1,0)(X8803,5c_c_cv_W,5c_c_cv_B)
			JCudaTensor x901;
			...
			// val X8805 = BatchNorm(5c_c_bn)(X8804,5c_c_bn_scale,5c_c_bn_bias)
			JCudaTensor x907;
			...
			// val X8808 = ReLU()(X8807)
			JCudaTensor x919;
			JCudaTensor x920;
			x920 = x916;
			x919 = x812.forward(x920);

			// val X8809 = Pooling(7,1,0,false)(X8808)
			JCudaTensor x921;
			JCudaTensor x922;
			x922 = x919;
			x921 = x923.forward(x922);

			// val X8810 = (X8809[1><3])(i1 | @) * (fc_W)(i2 | @)
			JCudaTensor x924;
			JCudaMatrix x925;
			JCudaMatrix x926;
			JCudaTensor x927;
			...
			// val X3411 = X3212 * d_LogSoftmax()(X8813)/d_X8812
			JCudaTensor x950;
			...
			// val m1 = (i7071) => fc_W[@, i7071]
			JCudaMatrix x955;
			JCudaTensor x956;
			x956 = x930;
			x955 = x956.asMatrix(1, false);

			// val m6 = (i17) => X3411[@, i17]
			JCudaMatrix x957;
			JCudaTensor x958;
			x958 = x950;
			x957 = x958.asMatrix(1, false);

			// val m8 = (i21) => X8809[1><3][@, i21]
			JCudaMatrix x959;
			JCudaTensor x960;
			JCudaTensor x961;
			x961 = x921;
			...
			// val X3607 = X3605[1<>3] * d_Pooling(7,1,0,false)(X8809,X8808)/d_X8808
			JCudaTensor x972;
			...
			// val X3644 = X3607 * d_ReLU()(X8808)/d_X8807
			JCudaTensor x1009;
			...
			// val X3654 = X3644.copy * d_ReLU()(X8806)/d_X8805
			JCudaTensor x1013;
			...
			// val X3655 = X3654 * d_BatchNorm(5c_c_bn)(X8804,5c_c_bn_scale)/d_X8804
			JCudaTensor x1017;
			...
			// val X8611 = X3654 * d_BatchNorm(5c_c_bn)(X8804,5c_c_bn_scale)/d_5c_c_bn_bias
			JCudaTensor x1022;
			x1022 = x1021[2];

			// val X8612 = X3654 * d_BatchNorm(5c_c_bn)(X8804,5c_c_bn_scale)/d_5c_c_bn_scale
			JCudaTensor x1026;
			x1026 = x1021[1];
			...
			// val X3656 = X3655 * d_Convolv(1,0)(5c_c_cv_W)/d_X8803
			JCudaTensor x1031;
			...
			// V_5c_c_cv_W <~~ X3655 * d_Convolv(1,0)(X8803)/d_5c_c_cv_W
			float x1049, x1050;
			float x1051;
			float x1052;
			x1051 = 1;
			...
			// val X3660 = X3656 * d_ReLU()(X8803)/d_X8802
			JCudaTensor x1089;
			...
			// val X3661 = X3660 * d_BatchNorm(5c_b_bn)(X8801,5c_b_bn_scale)/d_X8801
			JCudaTensor x1093;
			...
			// val X8608 = X3660 * d_BatchNorm(5c_b_bn)(X8801,5c_b_bn_scale)/d_5c_b_bn_bias
			JCudaTensor x1098;
			x1098 = x1097[2];

			// val X8609 = X3660 * d_BatchNorm(5c_b_bn)(X8801,5c_b_bn_scale)/d_5c_b_bn_scale
			JCudaTensor x1102;
			x1102 = x1097[1];
			...
			// val X3662 = X3661 * d_Convolv(1,1)(5c_b_cv_W)/d_X8800
			JCudaTensor x1121;
			...
			// V_5c_b_cv_W <~~ X3661 * d_Convolv(1,1)(X8800)/d_5c_b_cv_W
			float x1125, x1126;
			float x1127;
			float x1128;
			x1127 = 1;
			...
			// val X3666 = X3662 * d_ReLU()(X8800)/d_X8799
			JCudaTensor x1165;
			...
			// val X8606 = X3666 * d_BatchNorm(5c_a_bn)(X8798,5c_a_bn_scale)/d_5c_a_bn_scale
			JCudaTensor x1169;
			...
			// val X3667 = X3666 * d_BatchNorm(5c_a_bn)(X8798,5c_a_bn_scale)/d_X8798
			JCudaTensor x1174;
			x1174 = x1173[0];

			// val X8605 = X3666 * d_BatchNorm(5c_a_bn)(X8798,5c_a_bn_scale)/d_5c_a_bn_bias
			JCudaTensor x1178;
			x1178 = x1173[2];
			...
			// val X3668 = X3667 * d_Convolv(1,0)(5c_a_cv_W)/d_X8797
			JCudaTensor x1190;
			...
			// V_5c_a_cv_W <~~ X3667 * d_Convolv(1,0)(X8797)/d_5c_a_cv_W
			float x1201, x1202;
			float x1203;
			float x1204;
			x1203 = 1;
			...
			// val X3681 = X3669 * d_ReLU()(X8797)/d_X8796
			JCudaTensor x1245;
			...
			// val X3691 = X3681.copy * d_ReLU()(X8795)/d_X8794
			JCudaTensor x1249;
			...
			// val X8602 = X3691 * d_BatchNorm(5b_c_bn)(X8793,5b_c_bn_scale)/d_5b_c_bn_bias
			JCudaTensor x1253;
			...
			// val X3692 = X3691 * d_BatchNorm(5b_c_bn)(X8793,5b_c_bn_scale)/d_X8793
			JCudaTensor x1258;
			x1258 = x1257[0];

			// val X8603 = X3691 * d_BatchNorm(5b_c_bn)(X8793,5b_c_bn_scale)/d_5b_c_bn_scale
			JCudaTensor x1262;
			x1262 = x1257[1];
			...
			JCudaTensor x1279;
			x1279 = x1262;
			x1274.update(x1279, x1275, x1276);
			...
			// val X3693 = X3692 * d_Convolv(1,0)(5b_c_cv_W)/d_X8792
			JCudaTensor x1281;
			JCudaTensor x1282, x1283;
			x1282 = x1258;
			x1283 = x855;
			x1281 = x802.backward_data(x1282, x1283);

			// V_5b_c_cv_W <~~ X3692 * d_Convolv(1,0)(X8792)/d_5b_c_cv_W
			float x1285, x1286;
			float x1287;
			float x1288;
			x1287 = 1;
			...
			// val X3697 = X3693 * d_ReLU()(X8792)/d_X8791
			JCudaTensor x1325;
			...
			// val X3698 = X3697 * d_BatchNorm(5b_b_bn)(X8790,5b_b_bn_scale)/d_X8790
			JCudaTensor x1329;
			...
			// val X8599 = X3697 * d_BatchNorm(5b_b_bn)(X8790,5b_b_bn_scale)/d_5b_b_bn_bias
			JCudaTensor x1334;
			x1334 = x1333[2];

			// val X8600 = X3697 * d_BatchNorm(5b_b_bn)(X8790,5b_b_bn_scale)/d_5b_b_bn_scale
			JCudaTensor x1338;
			x1338 = x1333[1];
			...
			// val X3699 = X3698 * d_Convolv(1,1)(5b_b_cv_W)/d_X8789
			JCudaTensor x1343;
			JCudaTensor x1344, x1345;
			x1344 = x1329;
			x1345 = x840;
			x1343 = x786.backward_data(x1344, x1345);

			// V_5b_b_bn_scale <~~ X8600
			float x1347, x1348;
			float x1349;
			float x1350;
			x1349 = 1;
			...
			JCudaTensor x1351;
			x1351 = x1338;
			x1346.update(x1351, x1347, x1348);
			...
			// V_5b_b_cv_W <~~ X3698 * d_Convolv(1,1)(X8789)/d_5b_b_cv_W
			float x1361, x1362;
			float x1363;
			float x1364;
			x1363 = 1;
			...
			// val X3703 = X3699 * d_ReLU()(X8789)/d_X8788
			JCudaTensor x1401;
			...
			// val X8597 = X3703 * d_BatchNorm(5b_a_bn)(X8787,5b_a_bn_scale)/d_5b_a_bn_scale
			JCudaTensor x1405;
			...
			// val X3704 = X3703 * d_BatchNorm(5b_a_bn)(X8787,5b_a_bn_scale)/d_X8787
			JCudaTensor x1410;
			x1410 = x1409[0];

			// val X8596 = X3703 * d_BatchNorm(5b_a_bn)(X8787,5b_a_bn_scale)/d_5b_a_bn_bias
			JCudaTensor x1414;
			x1414 = x1409[2];
			...
			// val X3705 = X3704 * d_Convolv(1,0)(5b_a_cv_W)/d_X8786
			JCudaTensor x1433;
			...
			// V_5b_a_cv_W <~~ X3704 * d_Convolv(1,0)(X8786)/d_5b_a_cv_W
			float x1437, x1438;
			float x1439;
			float x1440;
			x1439 = 1;
			...
			// val X3721 = X3706 * d_ReLU()(X8786)/d_X8785
			JCudaTensor x1481;
			...
			// val X3725 = X3721.copy * d_ReLU()(X8775)/d_X8774
			JCudaTensor x1485;
			...
			// val X3737 = X3721.copy * d_ReLU()(X8784)/d_X8783
			JCudaTensor x1489;
			...
			// val X8585 = X3725 * d_BatchNorm(5a1_bn)(X8773,5a1_bn_scale)/d_5a1_bn_scale
			JCudaTensor x1494;
			...
			// val X3726 = X3725 * d_BatchNorm(5a1_bn)(X8773,5a1_bn_scale)/d_X8773
			JCudaTensor x1499;
			x1499 = x1498[0];

			// val X8594 = X3737 * d_BatchNorm(5a2_c_bn)(X8782,5a2_c_bn_scale)/d_5a2_c_bn_scale
			JCudaTensor x1503;
			...
			// val X3738 = X3737 * d_BatchNorm(5a2_c_bn)(X8782,5a2_c_bn_scale)/d_X8782
			JCudaTensor x1508;
			x1508 = x1507[0];

			// val X8593 = X3737 * d_BatchNorm(5a2_c_bn)(X8782,5a2_c_bn_scale)/d_5a2_c_bn_bias
			JCudaTensor x1512;
			x1512 = x1507[2];
			...
			// val X8584 = X3725 * d_BatchNorm(5a1_bn)(X8773,5a1_bn_scale)/d_5a1_bn_bias
			JCudaTensor x1517;
			x1517 = x1498[2];
			...
			// V_5a2_c_cv_W <~~ X3738 * d_Convolv(1,0)(X8781)/d_5a2_c_cv_W
			float x1523, x1524;
			float x1525;
			float x1526;
			x1525 = 1;
			...
			x1523 = x1525 * x1526;
			x1524 = momentum;
			JCudaTensor x1527, x1528;
			x1527 = x1508;
			x1528 = x794;
			x802.backward_filter(x1527, x1528, x1522, x1523, x1524);

			// V_5a2_c_bn_scale <~~ X8594
			float x1530, x1531;
			float x1532;
			float x1533;
			x1532 = 1;
			...
			JCudaTensor x1534;
			x1534 = x1503;
			x1529.update(x1534, x1530, x1531);
			...
			// val X3739 = X3738 * d_Convolv(1,0)(5a2_c_cv_W)/d_X8781
			JCudaTensor x1536;
			...
			// val X3727 = X3726 * d_Convolv(2,0)(5a1_cv_W)/d_X8772
			JCudaTensor x1540;
			JCudaTensor x1541, x1542;
			x1541 = x1499;
			x1542 = x753;
			x1540 = x755.backward_data(x1541, x1542);
			...
			JCudaTensor x1548;
			x1548 = x1517;
			x1543.update(x1548, x1544, x1545);
			...
			// V_5a1_cv_W <~~ X3726 * d_Convolv(2,0)(X8772)/d_5a1_cv_W
			float x1551, x1552;
			float x1553;
			float x1554;
			x1553 = 1;
			...
			x1555 = x1499;
			x1556 = x747;
			x755.backward_filter(x1555, x1556, x1550, x1551, x1552);
			...
			JCudaTensor x1563;
			x1563 = x1494;
			x1558.update(x1563, x1559, x1560);
			...
			JCudaTensor x1570;
			x1570 = x1512;
			x1565.update(x1570, x1566, x1567);
			...
			// val X3743 = X3739 * d_ReLU()(X8781)/d_X8780
			JCudaTensor x1638;
			...
			// val X8590 = X3743 * d_BatchNorm(5a2_b_bn)(X8779,5a2_b_bn_scale)/d_5a2_b_bn_bias
			JCudaTensor x1642;
			...
			// val X3744 = X3743 * d_BatchNorm(5a2_b_bn)(X8779,5a2_b_bn_scale)/d_X8779
			JCudaTensor x1647;
			x1647 = x1646[0];

			// val X8591 = X3743 * d_BatchNorm(5a2_b_bn)(X8779,5a2_b_bn_scale)/d_5a2_b_bn_scale
			JCudaTensor x1651;
			x1651 = x1646[1];
			...
			// val X3745 = X3744 * d_Convolv(1,1)(5a2_b_cv_W)/d_X8778
			JCudaTensor x1663;
			...
			// V_5a2_b_cv_W <~~ X3744 * d_Convolv(1,1)(X8778)/d_5a2_b_cv_W
			float x1667, x1668;
			float x1669;
			float x1670;
			x1669 = 1;
			...
			// val X3749 = X3745 * d_ReLU()(X8778)/d_X8777
			JCudaTensor x1714;
			...
			// val X8588 = X3749 * d_BatchNorm(5a2_a_bn)(X8776,5a2_a_bn_scale)/d_5a2_a_bn_scale
			JCudaTensor x1718;
			...
			// val X3750 = X3749 * d_BatchNorm(5a2_a_bn)(X8776,5a2_a_bn_scale)/d_X8776
			JCudaTensor x1723;
			x1723 = x1722[0];

			// val X8587 = X3749 * d_BatchNorm(5a2_a_bn)(X8776,5a2_a_bn_scale)/d_5a2_a_bn_bias
			JCudaTensor x1727;
			x1727 = x1722[2];
			...
			// val X3752 = (X3727 + X3750 * d_Convolv(2,0)(5a2_a_cv_W)/d_X8772)
			JCudaTensor x1739;
			JCudaTensor x1740;
			x1740 = x1540;
			...
			x1741 = x1723;
			x1742 = x760;
			x1739 = x762.backward_data(x1741,x1742, x1740);

			// V_5a2_a_cv_W <~~ X3750 * d_Convolv(2,0)(X8772)/d_5a2_a_cv_W
			float x1744, x1745;
			float x1746;
			float x1747;
			x1746 = 1;
			...
			x1748 = x1723;
			x1749 = x747;
			x762.backward_filter(x1748, x1749, x1743, x1744, x1745);
			...
			// val X3822 = X3752 * d_ReLU()(X8772)/d_X8771
			JCudaTensor x1791;
			...
			// val X3832 = X3822.copy * d_ReLU()(X8770)/d_X8769
			JCudaTensor x1795;
			...
			// val X8582 = X3832 * d_BatchNorm(4f_c_bn)(X8768,4f_c_bn_scale)/d_4f_c_bn_scale
			JCudaTensor x1799;
			...
			// val X3833 = X3832 * d_BatchNorm(4f_c_bn)(X8768,4f_c_bn_scale)/d_X8768
			JCudaTensor x1804;
			x1804 = x1803[0];

			// val X8581 = X3832 * d_BatchNorm(4f_c_bn)(X8768,4f_c_bn_scale)/d_4f_c_bn_bias
			JCudaTensor x1808;
			x1808 = x1803[2];
			...
			// val X3834 = X3833 * d_Convolv(1,0)(4f_c_cv_W)/d_X8767
			JCudaTensor x1820;
			...
			// V_4f_c_cv_W <~~ X3833 * d_Convolv(1,0)(X8767)/d_4f_c_cv_W
			float x1824, x1825;
			float x1826;
			float x1827;
			x1826 = 1;
			...
			// val X3838 = X3834 * d_ReLU()(X8767)/d_X8766
			JCudaTensor x1871;
			...
			// val X8579 = X3838 * d_BatchNorm(4f_b_bn)(X8765,4f_b_bn_scale)/d_4f_b_bn_scale
			JCudaTensor x1875;
			...
			// val X8578 = X3838 * d_BatchNorm(4f_b_bn)(X8765,4f_b_bn_scale)/d_4f_b_bn_bias
			JCudaTensor x1880;
			x1880 = x1879[2];

			// val X3839 = X3838 * d_BatchNorm(4f_b_bn)(X8765,4f_b_bn_scale)/d_X8765
			JCudaTensor x1884;
			x1884 = x1879[0];
			...
			// val X3840 = X3839 * d_Convolv(1,1)(4f_b_cv_W)/d_X8764
			JCudaTensor x1896;
			...
			// V_4f_b_cv_W <~~ X3839 * d_Convolv(1,1)(X8764)/d_4f_b_cv_W
			float x1900, x1901;
			float x1902;
			float x1903;
			x1902 = 1;
			...
			// val X3844 = X3840 * d_ReLU()(X8764)/d_X8763
			JCudaTensor x1947;
			...
			// val X8576 = X3844 * d_BatchNorm(4f_a_bn)(X8762,4f_a_bn_scale)/d_4f_a_bn_scale
			JCudaTensor x1951;
			...
			// val X3845 = X3844 * d_BatchNorm(4f_a_bn)(X8762,4f_a_bn_scale)/d_X8762
			JCudaTensor x1956;
			x1956 = x1955[0];

			// val X8575 = X3844 * d_BatchNorm(4f_a_bn)(X8762,4f_a_bn_scale)/d_4f_a_bn_bias
			JCudaTensor x1960;
			x1960 = x1955[2];
			...
			// val X3846 = X3845 * d_Convolv(1,0)(4f_a_cv_W)/d_X8761
			JCudaTensor x1965;
			...
			// V_4f_a_cv_W <~~ X3845 * d_Convolv(1,0)(X8761)/d_4f_a_cv_W
			float x1969, x1970;
			float x1971;
			float x1972;
			x1971 = 1;
			...
			// val X3859 = X3847 * d_ReLU()(X8761)/d_X8760
			JCudaTensor x2027;
			...
			// val X3869 = X3859.copy * d_ReLU()(X8759)/d_X8758
			JCudaTensor x2031;
			...
			// val X3870 = X3869 * d_BatchNorm(4e_c_bn)(X8757,4e_c_bn_scale)/d_X8757
			JCudaTensor x2035;
			...
			// val X8572 = X3869 * d_BatchNorm(4e_c_bn)(X8757,4e_c_bn_scale)/d_4e_c_bn_bias
			JCudaTensor x2040;
			x2040 = x2039[2];

			// val X8573 = X3869 * d_BatchNorm(4e_c_bn)(X8757,4e_c_bn_scale)/d_4e_c_bn_scale
			JCudaTensor x2044;
			x2044 = x2039[1];
			...
			// val X3871 = X3870 * d_Convolv(1,0)(4e_c_cv_W)/d_X8756
			JCudaTensor x2063;
			...
			// V_4e_c_cv_W <~~ X3870 * d_Convolv(1,0)(X8756)/d_4e_c_cv_W
			float x2067, x2068;
			float x2069;
			float x2070;
			x2069 = 1;
			...
			// val X3875 = X3871 * d_ReLU()(X8756)/d_X8755
			JCudaTensor x2107;
			...
			// val X3876 = X3875 * d_BatchNorm(4e_b_bn)(X8754,4e_b_bn_scale)/d_X8754
			JCudaTensor x2111;
			...
			// val X8570 = X3875 * d_BatchNorm(4e_b_bn)(X8754,4e_b_bn_scale)/d_4e_b_bn_scale
			JCudaTensor x2116;
			x2116 = x2115[1];

			// val X8569 = X3875 * d_BatchNorm(4e_b_bn)(X8754,4e_b_bn_scale)/d_4e_b_bn_bias
			JCudaTensor x2120;
			x2120 = x2115[2];
			...
			// val X3877 = X3876 * d_Convolv(1,1)(4e_b_cv_W)/d_X8753
			JCudaTensor x2125;
			...
			// V_4e_b_cv_W <~~ X3876 * d_Convolv(1,1)(X8753)/d_4e_b_cv_W
			float x2136, x2137;
			float x2138;
			float x2139;
			x2138 = 1;
			...
			// val X3881 = X3877 * d_ReLU()(X8753)/d_X8752
			JCudaTensor x2183;
			...
			// val X8567 = X3881 * d_BatchNorm(4e_a_bn)(X8751,4e_a_bn_scale)/d_4e_a_bn_scale
			JCudaTensor x2187;
			...
			// val X3882 = X3881 * d_BatchNorm(4e_a_bn)(X8751,4e_a_bn_scale)/d_X8751
			JCudaTensor x2192;
			x2192 = x2191[0];

			// val X8566 = X3881 * d_BatchNorm(4e_a_bn)(X8751,4e_a_bn_scale)/d_4e_a_bn_bias
			JCudaTensor x2196;
			x2196 = x2191[2];
			...
			JCudaTensor x2206;
			x2206 = x2196;
			x2201.update(x2206, x2202, x2203);
			...
			// val X3883 = X3882 * d_Convolv(1,0)(4e_a_cv_W)/d_X8750
			JCudaTensor x2208;
			JCudaTensor x2209, x2210;
			x2209 = x2192;
			x2210 = x653;
			x2208 = x504.backward_data(x2209, x2210);

			// V_4e_a_bn_scale <~~ X8567
			float x2212, x2213;
			float x2214;
			float x2215;
			x2214 = 1;
			...
			// V_4e_a_cv_W <~~ X3882 * d_Convolv(1,0)(X8750)/d_4e_a_cv_W
			float x2219, x2220;
			float x2221;
			float x2222;
			x2221 = 1;
			...
			// val X3896 = X3884 * d_ReLU()(X8750)/d_X8749
			JCudaTensor x2263;
			...
			// val X3906 = X3896.copy * d_ReLU()(X8748)/d_X8747
			JCudaTensor x2267;
			...
			// val X3907 = X3906 * d_BatchNorm(4d_c_bn)(X8746,4d_c_bn_scale)/d_X8746
			JCudaTensor x2271;
			...
			// val X8563 = X3906 * d_BatchNorm(4d_c_bn)(X8746,4d_c_bn_scale)/d_4d_c_bn_bias
			JCudaTensor x2276;
			x2276 = x2275[2];

			// val X8564 = X3906 * d_BatchNorm(4d_c_bn)(X8746,4d_c_bn_scale)/d_4d_c_bn_scale
			JCudaTensor x2280;
			x2280 = x2275[1];
			...
			// val X3908 = X3907 * d_Convolv(1,0)(4d_c_cv_W)/d_X8745
			JCudaTensor x2292;
			...
			// V_4d_c_cv_W <~~ X3907 * d_Convolv(1,0)(X8745)/d_4d_c_cv_W
			float x2296, x2297;
			float x2298;
			float x2299;
			x2298 = 1;
			...
			// val X3912 = X3908 * d_ReLU()(X8745)/d_X8744
			JCudaTensor x2343;
			...
			// val X8561 = X3912 * d_BatchNorm(4d_b_bn)(X8743,4d_b_bn_scale)/d_4d_b_bn_scale
			JCudaTensor x2347;
			...
			// val X3913 = X3912 * d_BatchNorm(4d_b_bn)(X8743,4d_b_bn_scale)/d_X8743
			JCudaTensor x2352;
			x2352 = x2351[0];

			// val X8560 = X3912 * d_BatchNorm(4d_b_bn)(X8743,4d_b_bn_scale)/d_4d_b_bn_bias
			JCudaTensor x2356;
			x2356 = x2351[2];
			...
			// val X3914 = X3913 * d_Convolv(1,1)(4d_b_cv_W)/d_X8742
			JCudaTensor x2368;
			...
			// V_4d_b_cv_W <~~ X3913 * d_Convolv(1,1)(X8742)/d_4d_b_cv_W
			float x2372, x2373;
			float x2374;
			float x2375;
			x2374 = 1;
			...
			// val X3918 = X3914 * d_ReLU()(X8742)/d_X8741
			JCudaTensor x2419;
			...
			// val X3919 = X3918 * d_BatchNorm(4d_a_bn)(X8740,4d_a_bn_scale)/d_X8740
			JCudaTensor x2423;
			...
			// val X8557 = X3918 * d_BatchNorm(4d_a_bn)(X8740,4d_a_bn_scale)/d_4d_a_bn_bias
			JCudaTensor x2428;
			x2428 = x2427[2];

			// val X8558 = X3918 * d_BatchNorm(4d_a_bn)(X8740,4d_a_bn_scale)/d_4d_a_bn_scale
			JCudaTensor x2432;
			x2432 = x2427[1];
			...
			// val X3920 = X3919 * d_Convolv(1,0)(4d_a_cv_W)/d_X8739
			JCudaTensor x2437;
			JCudaTensor x2438, x2439;
			x2438 = x2423;
			x2439 = x603;
			x2437 = x504.backward_data(x2438, x2439);

			// V_4d_a_bn_bias <~~ X8557
			float x2441, x2442;
			float x2443;
			float x2444;
			x2443 = 1;
			...
			JCudaTensor x2445;
			x2445 = x2428;
			x2440.update(x2445, x2441, x2442);
			...
			// V_4d_a_cv_W <~~ X3919 * d_Convolv(1,0)(X8739)/d_4d_a_cv_W
			float x2455, x2456;
			float x2457;
			float x2458;
			x2457 = 1;
			...
			// val X3933 = X3921 * d_ReLU()(X8739)/d_X8738
			JCudaTensor x2499;
			...
			// val X3943 = X3933.copy * d_ReLU()(X8737)/d_X8736
			JCudaTensor x2503;
			...
			// val X3944 = X3943 * d_BatchNorm(4c_c_bn)(X8735,4c_c_bn_scale)/d_X8735
			JCudaTensor x2507;
			...
			// val X8555 = X3943 * d_BatchNorm(4c_c_bn)(X8735,4c_c_bn_scale)/d_4c_c_bn_scale
			JCudaTensor x2512;
			x2512 = x2511[1];

			// val X8554 = X3943 * d_BatchNorm(4c_c_bn)(X8735,4c_c_bn_scale)/d_4c_c_bn_bias
			JCudaTensor x2516;
			x2516 = x2511[2];
			...
			// val X3945 = X3944 * d_Convolv(1,0)(4c_c_cv_W)/d_X8734
			JCudaTensor x2521;
			JCudaTensor x2522, x2523;
			x2522 = x2507;
			x2523 = x583;
			x2521 = x480.backward_data(x2522, x2523);

			// V_4c_c_bn_scale <~~ X8555
			float x2525, x2526;
			float x2527;
			float x2528;
			x2527 = 1;
			...
			JCudaTensor x2529;
			x2529 = x2512;
			x2524.update(x2529, x2525, x2526);
			...
			// V_4c_c_cv_W <~~ X3944 * d_Convolv(1,0)(X8734)/d_4c_c_cv_W
			float x2532, x2533;
			float x2534;
			float x2535;
			x2534 = 1;
			...
			// val X3949 = X3945 * d_ReLU()(X8734)/d_X8733
			JCudaTensor x2579;
			...
			// val X3950 = X3949 * d_BatchNorm(4c_b_bn)(X8732,4c_b_bn_scale)/d_X8732
			JCudaTensor x2583;
			...
			// val X8552 = X3949 * d_BatchNorm(4c_b_bn)(X8732,4c_b_bn_scale)/d_4c_b_bn_scale
			JCudaTensor x2588;
			x2588 = x2587[1];

			// val X8551 = X3949 * d_BatchNorm(4c_b_bn)(X8732,4c_b_bn_scale)/d_4c_b_bn_bias
			JCudaTensor x2592;
			x2592 = x2587[2];
			...
			// val X3951 = X3950 * d_Convolv(1,1)(4c_b_cv_W)/d_X8731
			JCudaTensor x2597;
			JCudaTensor x2598, x2599;
			x2598 = x2583;
			x2599 = x568;
			x2597 = x464.backward_data(x2598, x2599);

			// V_4c_b_bn_scale <~~ X8552
			float x2601, x2602;
			float x2603;
			float x2604;
			x2603 = 1;
			...
			JCudaTensor x2605;
			x2605 = x2588;
			x2600.update(x2605, x2601, x2602);
			...
			// V_4c_b_cv_W <~~ X3950 * d_Convolv(1,1)(X8731)/d_4c_b_cv_W
			float x2608, x2609;
			float x2610;
			float x2611;
			x2610 = 1;
			...
			// val X3955 = X3951 * d_ReLU()(X8731)/d_X8730
			JCudaTensor x2655;
			...
			// val X3956 = X3955 * d_BatchNorm(4c_a_bn)(X8729,4c_a_bn_scale)/d_X8729
			JCudaTensor x2659;
			...
			// val X8548 = X3955 * d_BatchNorm(4c_a_bn)(X8729,4c_a_bn_scale)/d_4c_a_bn_bias
			JCudaTensor x2664;
			x2664 = x2663[2];

			// val X8549 = X3955 * d_BatchNorm(4c_a_bn)(X8729,4c_a_bn_scale)/d_4c_a_bn_scale
			JCudaTensor x2668;
			x2668 = x2663[1];
			...
			// val X3957 = X3956 * d_Convolv(1,0)(4c_a_cv_W)/d_X8728
			JCudaTensor x2673;
			...
			// V_4c_a_cv_W <~~ X3956 * d_Convolv(1,0)(X8728)/d_4c_a_cv_W
			float x2677, x2678;
			float x2679;
			float x2680;
			x2679 = 1;
			...
			// val X3970 = X3958 * d_ReLU()(X8728)/d_X8727
			JCudaTensor x2735;
			...
			// val X3980 = X3970.copy * d_ReLU()(X8726)/d_X8725
			JCudaTensor x2739;
			...
			// val X3981 = X3980 * d_BatchNorm(4b_c_bn)(X8724,4b_c_bn_scale)/d_X8724
			JCudaTensor x2743;
			...
			// val X8545 = X3980 * d_BatchNorm(4b_c_bn)(X8724,4b_c_bn_scale)/d_4b_c_bn_bias
			JCudaTensor x2748;
			x2748 = x2747[2];

			// val X8546 = X3980 * d_BatchNorm(4b_c_bn)(X8724,4b_c_bn_scale)/d_4b_c_bn_scale
			JCudaTensor x2752;
			x2752 = x2747[1];
			...
			// val X3982 = X3981 * d_Convolv(1,0)(4b_c_cv_W)/d_X8723
			JCudaTensor x2757;
			...
			// V_4b_c_cv_W <~~ X3981 * d_Convolv(1,0)(X8723)/d_4b_c_cv_W
			float x2761, x2762;
			float x2763;
			float x2764;
			x2763 = 1;
			...
			// val X3986 = X3982 * d_ReLU()(X8723)/d_X8722
			JCudaTensor x2815;
			...
			// val X3987 = X3986 * d_BatchNorm(4b_b_bn)(X8721,4b_b_bn_scale)/d_X8721
			JCudaTensor x2819;
			...
			// val X8542 = X3986 * d_BatchNorm(4b_b_bn)(X8721,4b_b_bn_scale)/d_4b_b_bn_bias
			JCudaTensor x2824;
			x2824 = x2823[2];

			// val X8543 = X3986 * d_BatchNorm(4b_b_bn)(X8721,4b_b_bn_scale)/d_4b_b_bn_scale
			JCudaTensor x2828;
			x2828 = x2823[1];
			...
			// val X3988 = X3987 * d_Convolv(1,1)(4b_b_cv_W)/d_X8720
			JCudaTensor x2833;
			...
			// V_4b_b_cv_W <~~ X3987 * d_Convolv(1,1)(X8720)/d_4b_b_cv_W
			float x2837, x2838;
			float x2839;
			float x2840;
			x2839 = 1;
			...
			// val X3992 = X3988 * d_ReLU()(X8720)/d_X8719
			JCudaTensor x2891;
			...
			// val X8539 = X3992 * d_BatchNorm(4b_a_bn)(X8718,4b_a_bn_scale)/d_4b_a_bn_bias
			JCudaTensor x2895;
			...
			// val X3993 = X3992 * d_BatchNorm(4b_a_bn)(X8718,4b_a_bn_scale)/d_X8718
			JCudaTensor x2900;
			x2900 = x2899[0];

			// val X8540 = X3992 * d_BatchNorm(4b_a_bn)(X8718,4b_a_bn_scale)/d_4b_a_bn_scale
			JCudaTensor x2904;
			x2904 = x2899[1];
			...
			// val X3994 = X3993 * d_Convolv(1,0)(4b_a_cv_W)/d_X8717
			JCudaTensor x2916;
			...
			// V_4b_a_cv_W <~~ X3993 * d_Convolv(1,0)(X8717)/d_4b_a_cv_W
			float x2920, x2921;
			float x2922;
			float x2923;
			x2922 = 1;
			...
			// val X4010 = X3995 * d_ReLU()(X8717)/d_X8716
			JCudaTensor x2971;
			...
			// val X4026 = X4010.copy * d_ReLU()(X8715)/d_X8714
			JCudaTensor x2975;
			...
			// val X4014 = X4010.copy * d_ReLU()(X8706)/d_X8705
			JCudaTensor x2979;
			...
			// val X8537 = X4026 * d_BatchNorm(4a2_c_bn)(X8713,4a2_c_bn_scale)/d_4a2_c_bn_scale
			JCudaTensor x2984;
			JCudaTensor x2985, x2986, x2987;
			x2985 = x2975;
			x2986 = x474;
			x2987 = x485;
			JCudaTensor[] x2988 = x487.backward(x2985,x2986,x2987);
			x2984 = x2988[1];

			// val X8536 = X4026 * d_BatchNorm(4a2_c_bn)(X8713,4a2_c_bn_scale)/d_4a2_c_bn_bias
			JCudaTensor x2989;
			x2989 = x2988[2];

			// val X4015 = X4014 * d_BatchNorm(4a1_bn)(X8704,4a1_bn_scale)/d_X8704
			JCudaTensor x2993;
			JCudaTensor x2994, x2995, x2996;
			x2994 = x2979;
			x2995 = x427;
			x2996 = x452;
			JCudaTensor[] x2997 = x454.backward(x2994,x2995,x2996);
			x2993 = x2997[0];

			// val X4027 = X4026 * d_BatchNorm(4a2_c_bn)(X8713,4a2_c_bn_scale)/d_X8713
			JCudaTensor x2998;
			x2998 = x2988[0];
			...
			// val X8527 = X4014 * d_BatchNorm(4a1_bn)(X8704,4a1_bn_scale)/d_4a1_bn_bias
			JCudaTensor x3003;
			x3003 = x2997[2];

			// val X8528 = X4014 * d_BatchNorm(4a1_bn)(X8704,4a1_bn_scale)/d_4a1_bn_scale
			JCudaTensor x3007;
			x3007 = x2997[1];
			...
			// V_4a1_cv_W <~~ X4015 * d_Convolv(2,0)(X8703)/d_4a1_cv_W
			float x3020, x3021;
			float x3022;
			float x3023;
			x3022 = 1;
			...
			// V_4a2_c_cv_W <~~ X4027 * d_Convolv(1,0)(X8712)/d_4a2_c_cv_W
			float x3027, x3028;
			float x3029;
			float x3030;
			x3029 = 1;
			...
			x3027 = x3029 * x3030;
			x3028 = momentum;
			JCudaTensor x3031, x3032;
			x3031 = x2998;
			x3032 = x472;
			x480.backward_filter(x3031, x3032, x3026, x3027, x3028);
			...
			JCudaTensor x3038;
			x3038 = x3003;
			x3033.update(x3038, x3034, x3035);
			...
			// val X4028 = X4027 * d_Convolv(1,0)(4a2_c_cv_W)/d_X8712
			JCudaTensor x3040;
			JCudaTensor x3041, x3042;
			x3041 = x2998;
			x3042 = x478;
			x3040 = x480.backward_data(x3041, x3042);
			...
			JCudaTensor x3049;
			x3049 = x2984;
			x3044.update(x3049, x3045, x3046);
			...
			JCudaTensor x3056;
			x3056 = x3007;
			x3051.update(x3056, x3052, x3053);
			...
			// val X4016 = X4015 * d_Convolv(2,0)(4a1_cv_W)/d_X8703
			JCudaTensor x3058;
			JCudaTensor x3059, x3060;
			x3059 = x2993;
			x3060 = x431;
			x3058 = x433.backward_data(x3059, x3060);
			...
			// val X4032 = X4028 * d_ReLU()(X8712)/d_X8711
			JCudaTensor x3128;
			...
			// val X8533 = X4032 * d_BatchNorm(4a2_b_bn)(X8710,4a2_b_bn_scale)/d_4a2_b_bn_bias
			JCudaTensor x3132;
			...
			// val X4033 = X4032 * d_BatchNorm(4a2_b_bn)(X8710,4a2_b_bn_scale)/d_X8710
			JCudaTensor x3137;
			x3137 = x3136[0];

			// val X8534 = X4032 * d_BatchNorm(4a2_b_bn)(X8710,4a2_b_bn_scale)/d_4a2_b_bn_scale
			JCudaTensor x3141;
			x3141 = x3136[1];
			...
			// val X4034 = X4033 * d_Convolv(1,1)(4a2_b_cv_W)/d_X8709
			JCudaTensor x3160;
			...
			// V_4a2_b_cv_W <~~ X4033 * d_Convolv(1,1)(X8709)/d_4a2_b_cv_W
			float x3164, x3165;
			float x3166;
			float x3167;
			x3166 = 1;
			...
			// val X4038 = X4034 * d_ReLU()(X8709)/d_X8708
			JCudaTensor x3204;
			...
			// val X4039 = X4038 * d_BatchNorm(4a2_a_bn)(X8707,4a2_a_bn_scale)/d_X8707
			JCudaTensor x3208;
			JCudaTensor x3209, x3210, x3211;
			x3209 = x3204;
			x3210 = x434;
			x3211 = x445;
			JCudaTensor[] x3212 = x447.backward(x3209,x3210,x3211);
			x3208 = x3212[0];

			// val X8531 = X4038 * d_BatchNorm(4a2_a_bn)(X8707,4a2_a_bn_scale)/d_4a2_a_bn_scale
			JCudaTensor x3213;
			x3213 = x3212[1];

			// val X8530 = X4038 * d_BatchNorm(4a2_a_bn)(X8707,4a2_a_bn_scale)/d_4a2_a_bn_bias
			JCudaTensor x3217;
			x3217 = x3212[2];
			...
			// val X4041 = (X4016 + X4039 * d_Convolv(2,0)(4a2_a_cv_W)/d_X8703)
			JCudaTensor x3229;
			JCudaTensor x3230;
			x3230 = x3058;
			...
			// V_4a2_a_cv_W <~~ X4039 * d_Convolv(2,0)(X8703)/d_4a2_a_cv_W
			float x3234, x3235;
			float x3236;
			float x3237;
			x3236 = 1;
			...
			JCudaTensor x3280;
			x3280 = x3241;
			x446.update(x3280, x3270, x3271);

			// val X4089 = X4041 * d_ReLU()(X8703)/d_X8702
			JCudaTensor x3281;
			...
			// val X4099 = X4089.copy * d_ReLU()(X8701)/d_X8700
			JCudaTensor x3285;
			...
			// val X8524 = X4099 * d_BatchNorm(3d_c_bn)(X8699,3d_c_bn_scale)/d_3d_c_bn_bias
			JCudaTensor x3289;
			...
			// val X4100 = X4099 * d_BatchNorm(3d_c_bn)(X8699,3d_c_bn_scale)/d_X8699
			JCudaTensor x3294;
			x3294 = x3293[0];

			// val X8525 = X4099 * d_BatchNorm(3d_c_bn)(X8699,3d_c_bn_scale)/d_3d_c_bn_scale
			JCudaTensor x3298;
			x3298 = x3293[1];
			...
			// val X4101 = X4100 * d_Convolv(1,0)(3d_c_cv_W)/d_X8698
			JCudaTensor x3310;
			JCudaTensor x3311, x3312;
			x3311 = x3294;
			x3312 = x411;
			x3310 = x258.backward_data(x3311, x3312);

			// V_3d_c_bn_scale <~~ X8525
			float x3314, x3315;
			float x3316;
			float x3317;
			x3316 = 1;
			...
			JCudaTensor x3318;
			x3318 = x3298;
			x3313.update(x3318, x3314, x3315);
			...
			// V_3d_c_cv_W <~~ X4100 * d_Convolv(1,0)(X8698)/d_3d_c_cv_W
			float x3321, x3322;
			float x3323;
			float x3324;
			x3323 = 1;
			...
			// val X4105 = X4101 * d_ReLU()(X8698)/d_X8697
			JCudaTensor x3361;
			...
			// val X8522 = X4105 * d_BatchNorm(3d_b_bn)(X8696,3d_b_bn_scale)/d_3d_b_bn_scale
			JCudaTensor x3365;
			...
			// val X4106 = X4105 * d_BatchNorm(3d_b_bn)(X8696,3d_b_bn_scale)/d_X8696
			JCudaTensor x3370;
			x3370 = x3369[0];

			// val X8521 = X4105 * d_BatchNorm(3d_b_bn)(X8696,3d_b_bn_scale)/d_3d_b_bn_bias
			JCudaTensor x3374;
			x3374 = x3369[2];
			...
			// val X4107 = X4106 * d_Convolv(1,1)(3d_b_cv_W)/d_X8695
			JCudaTensor x3386;
			...
			// V_3d_b_cv_W <~~ X4106 * d_Convolv(1,1)(X8695)/d_3d_b_cv_W
			float x3390, x3391;
			float x3392;
			float x3393;
			x3392 = 1;
			...
			// val X4111 = X4107 * d_ReLU()(X8695)/d_X8694
			JCudaTensor x3437;
			...
			// val X8518 = X4111 * d_BatchNorm(3d_a_bn)(X8693,3d_a_bn_scale)/d_3d_a_bn_bias
			JCudaTensor x3441;
			...
			// val X8519 = X4111 * d_BatchNorm(3d_a_bn)(X8693,3d_a_bn_scale)/d_3d_a_bn_scale
			JCudaTensor x3446;
			x3446 = x3445[1];

			// val X4112 = X4111 * d_BatchNorm(3d_a_bn)(X8693,3d_a_bn_scale)/d_X8693
			JCudaTensor x3450;
			x3450 = x3445[0];
			...
			// val X4113 = X4112 * d_Convolv(1,0)(3d_a_cv_W)/d_X8692
			JCudaTensor x3462;
			JCudaTensor x3463, x3464;
			x3463 = x3450;
			x3464 = x381;
			x3462 = x282.backward_data(x3463, x3464);

			// V_3d_a_bn_scale <~~ X8519
			float x3466, x3467;
			float x3468;
			float x3469;
			x3468 = 1;
			...
			JCudaTensor x3470;
			x3470 = x3446;
			x3465.update(x3470, x3466, x3467);
			...
			// V_3d_a_cv_W <~~ X4112 * d_Convolv(1,0)(X8692)/d_3d_a_cv_W
			float x3473, x3474;
			float x3475;
			float x3476;
			x3475 = 1;
			...
			// val X4126 = X4114 * d_ReLU()(X8692)/d_X8691
			JCudaTensor x3517;
			...
			// val X4136 = X4126.copy * d_ReLU()(X8690)/d_X8689
			JCudaTensor x3521;
			...
			// val X4137 = X4136 * d_BatchNorm(3c_c_bn)(X8688,3c_c_bn_scale)/d_X8688
			JCudaTensor x3525;
			...
			// val X8516 = X4136 * d_BatchNorm(3c_c_bn)(X8688,3c_c_bn_scale)/d_3c_c_bn_scale
			JCudaTensor x3530;
			x3530 = x3529[1];

			// val X8515 = X4136 * d_BatchNorm(3c_c_bn)(X8688,3c_c_bn_scale)/d_3c_c_bn_bias
			JCudaTensor x3534;
			x3534 = x3529[2];
			...
			// val X4138 = X4137 * d_Convolv(1,0)(3c_c_cv_W)/d_X8687
			JCudaTensor x3546;
			...
			// V_3c_c_cv_W <~~ X4137 * d_Convolv(1,0)(X8687)/d_3c_c_cv_W
			float x3557, x3558;
			float x3559;
			float x3560;
			x3559 = 1;
			...
			// val X4142 = X4138 * d_ReLU()(X8687)/d_X8686
			JCudaTensor x3597;
			...
			// val X4143 = X4142 * d_BatchNorm(3c_b_bn)(X8685,3c_b_bn_scale)/d_X8685
			JCudaTensor x3601;
			...
			// val X8513 = X4142 * d_BatchNorm(3c_b_bn)(X8685,3c_b_bn_scale)/d_3c_b_bn_scale
			JCudaTensor x3606;
			x3606 = x3605[1];

			// val X8512 = X4142 * d_BatchNorm(3c_b_bn)(X8685,3c_b_bn_scale)/d_3c_b_bn_bias
			JCudaTensor x3610;
			x3610 = x3605[2];
			...
			// val X4144 = X4143 * d_Convolv(1,1)(3c_b_cv_W)/d_X8684
			JCudaTensor x3615;
			...
			// V_3c_b_cv_W <~~ X4143 * d_Convolv(1,1)(X8684)/d_3c_b_cv_W
			float x3633, x3634;
			float x3635;
			float x3636;
			x3635 = 1;
			...
			// val X4148 = X4144 * d_ReLU()(X8684)/d_X8683
			JCudaTensor x3673;
			...
			// val X4149 = X4148 * d_BatchNorm(3c_a_bn)(X8682,3c_a_bn_scale)/d_X8682
			JCudaTensor x3677;
			...
			// val X8510 = X4148 * d_BatchNorm(3c_a_bn)(X8682,3c_a_bn_scale)/d_3c_a_bn_scale
			JCudaTensor x3682;
			x3682 = x3681[1];

			// val X8509 = X4148 * d_BatchNorm(3c_a_bn)(X8682,3c_a_bn_scale)/d_3c_a_bn_bias
			JCudaTensor x3686;
			x3686 = x3681[2];
			...
			// val X4150 = X4149 * d_Convolv(1,0)(3c_a_cv_W)/d_X8681
			JCudaTensor x3691;
			...
			// V_3c_a_cv_W <~~ X4149 * d_Convolv(1,0)(X8681)/d_3c_a_cv_W
			float x3709, x3710;
			float x3711;
			float x3712;
			x3711 = 1;
			...
			// val X4163 = X4151 * d_ReLU()(X8681)/d_X8680
			JCudaTensor x3753;
			...
			// val X4173 = X4163.copy * d_ReLU()(X8679)/d_X8678
			JCudaTensor x3757;
			...
			// val X8506 = X4173 * d_BatchNorm(3b_c_bn)(X8677,3b_c_bn_scale)/d_3b_c_bn_bias
			JCudaTensor x3761;
			...
			// val X4174 = X4173 * d_BatchNorm(3b_c_bn)(X8677,3b_c_bn_scale)/d_X8677
			JCudaTensor x3766;
			x3766 = x3765[0];

			// val X8507 = X4173 * d_BatchNorm(3b_c_bn)(X8677,3b_c_bn_scale)/d_3b_c_bn_scale
			JCudaTensor x3770;
			x3770 = x3765[1];
			...
			// val X4175 = X4174 * d_Convolv(1,0)(3b_c_cv_W)/d_X8676
			JCudaTensor x3775;
			...
			// V_3b_c_cv_W <~~ X4174 * d_Convolv(1,0)(X8676)/d_3b_c_cv_W
			float x3779, x3780;
			float x3781;
			float x3782;
			x3781 = 1;
			...
			// val X4179 = X4175 * d_ReLU()(X8676)/d_X8675
			JCudaTensor x3833;
			...
			// val X8504 = X4179 * d_BatchNorm(3b_b_bn)(X8674,3b_b_bn_scale)/d_3b_b_bn_scale
			JCudaTensor x3837;
			...
			// val X4180 = X4179 * d_BatchNorm(3b_b_bn)(X8674,3b_b_bn_scale)/d_X8674
			JCudaTensor x3842;
			x3842 = x3841[0];

			// val X8503 = X4179 * d_BatchNorm(3b_b_bn)(X8674,3b_b_bn_scale)/d_3b_b_bn_bias
			JCudaTensor x3846;
			x3846 = x3841[2];
			...
			// val X4181 = X4180 * d_Convolv(1,1)(3b_b_cv_W)/d_X8673
			JCudaTensor x3858;
			...
			// V_3b_b_cv_W <~~ X4180 * d_Convolv(1,1)(X8673)/d_3b_b_cv_W
			float x3862, x3863;
			float x3864;
			float x3865;
			x3864 = 1;
			...
			// val X4185 = X4181 * d_ReLU()(X8673)/d_X8672
			JCudaTensor x3909;
			...
			// val X8501 = X4185 * d_BatchNorm(3b_a_bn)(X8671,3b_a_bn_scale)/d_3b_a_bn_scale
			JCudaTensor x3913;
			...
			// val X4186 = X4185 * d_BatchNorm(3b_a_bn)(X8671,3b_a_bn_scale)/d_X8671
			JCudaTensor x3918;
			x3918 = x3917[0];

			// val X8500 = X4185 * d_BatchNorm(3b_a_bn)(X8671,3b_a_bn_scale)/d_3b_a_bn_bias
			JCudaTensor x3922;
			x3922 = x3917[2];
			...
			// val X4187 = X4186 * d_Convolv(1,0)(3b_a_cv_W)/d_X8670
			JCudaTensor x3934;
			JCudaTensor x3935, x3936;
			x3935 = x3918;
			x3936 = x280;
			x3934 = x282.backward_data(x3935, x3936);

			// V_3b_a_bn_scale <~~ X8501
			float x3938, x3939;
			float x3940;
			float x3941;
			x3940 = 1;
			...
			JCudaTensor x3942;
			x3942 = x3913;
			x3937.update(x3942, x3938, x3939);
			...
			// V_3b_a_cv_W <~~ X4186 * d_Convolv(1,0)(X8670)/d_3b_a_cv_W
			float x3945, x3946;
			float x3947;
			float x3948;
			x3947 = 1;
			...
			// val X4203 = X4188 * d_ReLU()(X8670)/d_X8669
			JCudaTensor x3989;
			...
			// val X4207 = X4203.copy * d_ReLU()(X8659)/d_X8658
			JCudaTensor x3993;
			...
			// val X4219 = X4203.copy * d_ReLU()(X8668)/d_X8667
			JCudaTensor x3997;
			...
			// val X4208 = X4207 * d_BatchNorm(3a1_bn)(X8657,3a1_bn_scale)/d_X8657
			JCudaTensor x4002;
			...
			// val X8488 = X4207 * d_BatchNorm(3a1_bn)(X8657,3a1_bn_scale)/d_3a1_bn_bias
			JCudaTensor x4007;
			x4007 = x4006[2];

			// val X8498 = X4219 * d_BatchNorm(3a2_c_bn)(X8666,3a2_c_bn_scale)/d_3a2_c_bn_scale
			JCudaTensor x4011;
			JCudaTensor x4012, x4013, x4014;
			x4012 = x3997;
			x4013 = x252;
			x4014 = x263;
			JCudaTensor[] x4015 = x265.backward(x4012,x4013,x4014);
			x4011 = x4015[1];

			// val X8497 = X4219 * d_BatchNorm(3a2_c_bn)(X8666,3a2_c_bn_scale)/d_3a2_c_bn_bias
			JCudaTensor x4016;
			x4016 = x4015[2];

			// val X8489 = X4207 * d_BatchNorm(3a1_bn)(X8657,3a1_bn_scale)/d_3a1_bn_scale
			JCudaTensor x4020;
			x4020 = x4006[1];
			...
			// val X4220 = X4219 * d_BatchNorm(3a2_c_bn)(X8666,3a2_c_bn_scale)/d_X8666
			JCudaTensor x4025;
			x4025 = x4015[0];
			...
			// val X4221 = X4220 * d_Convolv(1,0)(3a2_c_cv_W)/d_X8665
			JCudaTensor x4030;
			JCudaTensor x4031, x4032;
			x4031 = x4025;
			x4032 = x256;
			x4030 = x258.backward_data(x4031, x4032);

			// V_3a1_cv_W <~~ X4208 * d_Convolv(2,0)(X8656)/d_3a1_cv_W
			float x4034, x4035;
			float x4036;
			float x4037;
			x4036 = 1;
			...
			x4038 = x4002;
			x4039 = x203;
			x211.backward_filter(x4038, x4039, x4033, x4034, x4035);

			// V_3a2_c_bn_scale <~~ X8498
			float x4041, x4042;
			float x4043;
			float x4044;
			x4043 = 1;
			...
			JCudaTensor x4045;
			x4045 = x4011;
			x4040.update(x4045, x4041, x4042);
			...
			// V_3a2_c_cv_W <~~ X4220 * d_Convolv(1,0)(X8665)/d_3a2_c_cv_W
			float x4048, x4049;
			float x4050;
			float x4051;
			x4050 = 1;
			...
			x4048 = x4050 * x4051;
			x4049 = momentum;
			JCudaTensor x4052, x4053;
			x4052 = x4025;
			x4053 = x250;
			x258.backward_filter(x4052, x4053, x4047, x4048, x4049);
			...
			JCudaTensor x4060;
			x4060 = x4020;
			x4055.update(x4060, x4056, x4057);
			...
			// val X4209 = X4208 * d_Convolv(2,0)(3a1_cv_W)/d_X8656
			JCudaTensor x4062;
			JCudaTensor x4063, x4064;
			x4063 = x4002;
			x4064 = x209;
			x4062 = x211.backward_data(x4063, x4064);
			...
			JCudaTensor x4145;
			x4145 = x4033;
			x209.update(x4145, x4135, x4136);

			// val X4225 = X4221 * d_ReLU()(X8665)/d_X8664
			JCudaTensor x4146;
			...
			// val X8495 = X4225 * d_BatchNorm(3a2_b_bn)(X8663,3a2_b_bn_scale)/d_3a2_b_bn_scale
			JCudaTensor x4150;
			...
			// val X8494 = X4225 * d_BatchNorm(3a2_b_bn)(X8663,3a2_b_bn_scale)/d_3a2_b_bn_bias
			JCudaTensor x4155;
			x4155 = x4154[2];

			// val X4226 = X4225 * d_BatchNorm(3a2_b_bn)(X8663,3a2_b_bn_scale)/d_X8663
			JCudaTensor x4159;
			x4159 = x4154[0];
			...
			// val X4227 = X4226 * d_Convolv(1,1)(3a2_b_cv_W)/d_X8662
			JCudaTensor x4164;
			...
			// V_3a2_b_cv_W <~~ X4226 * d_Convolv(1,1)(X8662)/d_3a2_b_cv_W
			float x4168, x4169;
			float x4170;
			float x4171;
			x4170 = 1;
			...
			// val X4231 = X4227 * d_ReLU()(X8662)/d_X8661
			JCudaTensor x4222;
			...
			// val X4232 = X4231 * d_BatchNorm(3a2_a_bn)(X8660,3a2_a_bn_scale)/d_X8660
			JCudaTensor x4226;
			...
			// val X8491 = X4231 * d_BatchNorm(3a2_a_bn)(X8660,3a2_a_bn_scale)/d_3a2_a_bn_bias
			JCudaTensor x4231;
			x4231 = x4230[2];

			// val X8492 = X4231 * d_BatchNorm(3a2_a_bn)(X8660,3a2_a_bn_scale)/d_3a2_a_bn_scale
			JCudaTensor x4235;
			x4235 = x4230[1];
			...
			// val X4234 = (X4209 + X4232 * d_Convolv(2,0)(3a2_a_cv_W)/d_X8656)
			JCudaTensor x4247;
			JCudaTensor x4248;
			x4248 = x4062;
			...
			x4249 = x4226;
			x4250 = x216;
			x4247 = x218.backward_data(x4249,x4250, x4248);

			// V_3a2_a_cv_W <~~ X4232 * d_Convolv(2,0)(X8656)/d_3a2_a_cv_W
			float x4252, x4253;
			float x4254;
			float x4255;
			x4254 = 1;
			...
			x4256 = x4226;
			x4257 = x203;
			x218.backward_filter(x4256, x4257, x4251, x4252, x4253);
			...
			// val X4271 = X4234 * d_ReLU()(X8656)/d_X8655
			JCudaTensor x4299;
			...
			// val X4281 = X4271.copy * d_ReLU()(X8654)/d_X8653
			JCudaTensor x4303;
			...
			// val X4282 = X4281 * d_BatchNorm(2c_c_bn)(X8652,2c_c_bn_scale)/d_X8652
			JCudaTensor x4307;
			...
			// val X8485 = X4281 * d_BatchNorm(2c_c_bn)(X8652,2c_c_bn_scale)/d_2c_c_bn_bias
			JCudaTensor x4312;
			x4312 = x4311[2];

			// val X8486 = X4281 * d_BatchNorm(2c_c_bn)(X8652,2c_c_bn_scale)/d_2c_c_bn_scale
			JCudaTensor x4316;
			x4316 = x4311[1];
			...
			JCudaTensor x4326;
			x4326 = x4316;
			x4321.update(x4326, x4322, x4323);
			...
			// val X4283 = X4282 * d_Convolv(1,0)(2c_c_cv_W)/d_X8651
			JCudaTensor x4328;
			JCudaTensor x4329, x4330;
			x4329 = x4307;
			x4330 = x189;
			x4328 = x40.backward_data(x4329, x4330);

			// V_2c_c_bn_bias <~~ X8485
			float x4332, x4333;
			float x4334;
			float x4335;
			x4334 = 1;
			...
			// V_2c_c_cv_W <~~ X4282 * d_Convolv(1,0)(X8651)/d_2c_c_cv_W
			float x4339, x4340;
			float x4341;
			float x4342;
			x4341 = 1;
			...
			x4343 = x4307;
			x4344 = x183;
			x40.backward_filter(x4343, x4344, x4338, x4339, x4340);
			...
			// val X4287 = X4283 * d_ReLU()(X8651)/d_X8650
			JCudaTensor x4379;
			...
			// val X4288 = X4287 * d_BatchNorm(2c_b_bn)(X8649,2c_b_bn_scale)/d_X8649
			JCudaTensor x4383;
			...
			// val X8483 = X4287 * d_BatchNorm(2c_b_bn)(X8649,2c_b_bn_scale)/d_2c_b_bn_scale
			JCudaTensor x4388;
			x4388 = x4387[1];

			// val X8482 = X4287 * d_BatchNorm(2c_b_bn)(X8649,2c_b_bn_scale)/d_2c_b_bn_bias
			JCudaTensor x4392;
			x4392 = x4387[2];
			...
			JCudaTensor x4402;
			x4402 = x4392;
			x4397.update(x4402, x4398, x4399);
			...
			// val X4289 = X4288 * d_Convolv(1,1)(2c_b_cv_W)/d_X8648
			JCudaTensor x4404;
			JCudaTensor x4405, x4406;
			x4405 = x4383;
			x4406 = x174;
			x4404 = x71.backward_data(x4405, x4406);

			// V_2c_b_cv_W <~~ X4288 * d_Convolv(1,1)(X8648)/d_2c_b_cv_W
			float x4408, x4409;
			float x4410;
			float x4411;
			x4410 = 1;
			...
			// val X4293 = X4289 * d_ReLU()(X8648)/d_X8647
			JCudaTensor x4455;
			...
			// val X8479 = X4293 * d_BatchNorm(2c_a_bn)(X8646,2c_a_bn_scale)/d_2c_a_bn_bias
			JCudaTensor x4459;
			...
			// val X4294 = X4293 * d_BatchNorm(2c_a_bn)(X8646,2c_a_bn_scale)/d_X8646
			JCudaTensor x4464;
			x4464 = x4463[0];

			// val X8480 = X4293 * d_BatchNorm(2c_a_bn)(X8646,2c_a_bn_scale)/d_2c_a_bn_scale
			JCudaTensor x4468;
			x4468 = x4463[1];
			...
			// val X4295 = X4294 * d_Convolv(1,0)(2c_a_cv_W)/d_X8645
			JCudaTensor x4473;
			...
			// V_2c_a_cv_W <~~ X4294 * d_Convolv(1,0)(X8645)/d_2c_a_cv_W
			float x4477, x4478;
			float x4479;
			float x4480;
			x4479 = 1;
			...
			// val X4308 = X4296 * d_ReLU()(X8645)/d_X8644
			JCudaTensor x4535;
			...
			// val X4318 = X4308.copy * d_ReLU()(X8643)/d_X8642
			JCudaTensor x4539;
			...
			// val X8476 = X4318 * d_BatchNorm(2b_c_bn)(X8641,2b_c_bn_scale)/d_2b_c_bn_bias
			JCudaTensor x4543;
			...
			// val X4319 = X4318 * d_BatchNorm(2b_c_bn)(X8641,2b_c_bn_scale)/d_X8641
			JCudaTensor x4548;
			x4548 = x4547[0];

			// val X8477 = X4318 * d_BatchNorm(2b_c_bn)(X8641,2b_c_bn_scale)/d_2b_c_bn_scale
			JCudaTensor x4552;
			x4552 = x4547[1];
			...
			// val X4320 = X4319 * d_Convolv(1,0)(2b_c_cv_W)/d_X8640
			JCudaTensor x4564;
			JCudaTensor x4565, x4566;
			x4565 = x4548;
			x4566 = x139;
			x4564 = x40.backward_data(x4565, x4566);

			// V_2b_c_cv_W <~~ X4319 * d_Convolv(1,0)(X8640)/d_2b_c_cv_W
			float x4568, x4569;
			float x4570;
			float x4571;
			x4570 = 1;
			...
			x4572 = x4548;
			x4573 = x133;
			x40.backward_filter(x4572, x4573, x4567, x4568, x4569);
			...
			// val X4324 = X4320 * d_ReLU()(X8640)/d_X8639
			JCudaTensor x4615;
			...
			// val X8474 = X4324 * d_BatchNorm(2b_b_bn)(X8638,2b_b_bn_scale)/d_2b_b_bn_scale
			JCudaTensor x4619;
			...
			// val X4325 = X4324 * d_BatchNorm(2b_b_bn)(X8638,2b_b_bn_scale)/d_X8638
			JCudaTensor x4624;
			x4624 = x4623[0];

			// val X8473 = X4324 * d_BatchNorm(2b_b_bn)(X8638,2b_b_bn_scale)/d_2b_b_bn_bias
			JCudaTensor x4628;
			x4628 = x4623[2];
			...
			// val X4326 = X4325 * d_Convolv(1,1)(2b_b_cv_W)/d_X8637
			JCudaTensor x4647;
			...
			// V_2b_b_cv_W <~~ X4325 * d_Convolv(1,1)(X8637)/d_2b_b_cv_W
			float x4651, x4652;
			float x4653;
			float x4654;
			x4653 = 1;
			...
			// val X4330 = X4326 * d_ReLU()(X8637)/d_X8636
			JCudaTensor x4691;
			...
			// val X8470 = X4330 * d_BatchNorm(2b_a_bn)(X8635,2b_a_bn_scale)/d_2b_a_bn_bias
			JCudaTensor x4695;
			...
			// val X4331 = X4330 * d_BatchNorm(2b_a_bn)(X8635,2b_a_bn_scale)/d_X8635
			JCudaTensor x4700;
			x4700 = x4699[0];

			// val X8471 = X4330 * d_BatchNorm(2b_a_bn)(X8635,2b_a_bn_scale)/d_2b_a_bn_scale
			JCudaTensor x4704;
			x4704 = x4699[1];
			...
			// val X4332 = X4331 * d_Convolv(1,0)(2b_a_cv_W)/d_X8634
			JCudaTensor x4709;
			...
			// V_2b_a_cv_W <~~ X4331 * d_Convolv(1,0)(X8634)/d_2b_a_cv_W
			float x4713, x4714;
			float x4715;
			float x4716;
			x4715 = 1;
			...
			// val X4348 = X4333 * d_ReLU()(X8634)/d_X8633
			JCudaTensor x4771;
			...
			// val X4352 = X4348.copy * d_ReLU()(X8623)/d_X8622
			JCudaTensor x4775;
			...
			// val X4364 = X4348.copy * d_ReLU()(X8632)/d_X8631
			JCudaTensor x4779;
			...
			// val X8458 = X4352 * d_BatchNorm(2a1_bn)(X8621,2a1_bn_scale)/d_2a1_bn_bias
			JCudaTensor x4784;
			JCudaTensor x4785, x4786, x4787;
			x4785 = x4775;
			x4786 = x34;
			x4787 = x52;
			JCudaTensor[] x4788 = x54.backward(x4785,x4786,x4787);
			x4784 = x4788[2];

			// val X8468 = X4364 * d_BatchNorm(2a2_c_bn)(X8630,2a2_c_bn_scale)/d_2a2_c_bn_scale
			JCudaTensor x4789;
			JCudaTensor x4790, x4791, x4792;
			x4790 = x4779;
			x4791 = x81;
			x4792 = x91;
			JCudaTensor[] x4793 = x93.backward(x4790,x4791,x4792);
			x4789 = x4793[1];

			// val X4365 = X4364 * d_BatchNorm(2a2_c_bn)(X8630,2a2_c_bn_scale)/d_X8630
			JCudaTensor x4794;
			x4794 = x4793[0];

			// val X8459 = X4352 * d_BatchNorm(2a1_bn)(X8621,2a1_bn_scale)/d_2a1_bn_scale
			JCudaTensor x4798;
			x4798 = x4788[1];

			// val X4353 = X4352 * d_BatchNorm(2a1_bn)(X8621,2a1_bn_scale)/d_X8621
			JCudaTensor x4802;
			x4802 = x4788[0];
			...
			// val X8467 = X4364 * d_BatchNorm(2a2_c_bn)(X8630,2a2_c_bn_scale)/d_2a2_c_bn_bias
			JCudaTensor x4807;
			x4807 = x4793[2];
			...
			// V_2a1_cv_W <~~ X4353 * d_Convolv(1,0)(X8620)/d_2a1_cv_W
			float x4813, x4814;
			float x4815;
			float x4816;
			x4815 = 1;
			...
			x4813 = x4815 * x4816;
			x4814 = momentum;
			JCudaTensor x4817, x4818;
			x4817 = x4802;
			x4818 = x31;
			x40.backward_filter(x4817, x4818, x4812, x4813, x4814);
			...
			JCudaTensor x4824;
			x4824 = x4784;
			x4819.update(x4824, x4820, x4821);
			...
			// val X4366 = X4365 * d_Convolv(1,0)(2a2_c_cv_W)/d_X8629
			JCudaTensor x4826;
			JCudaTensor x4827, x4828;
			x4827 = x4794;
			x4828 = x85;
			x4826 = x40.backward_data(x4827, x4828);

			// V_2a2_c_cv_W <~~ X4365 * d_Convolv(1,0)(X8629)/d_2a2_c_cv_W
			float x4830, x4831;
			float x4832;
			float x4833;
			x4832 = 1;
			...
			x4834 = x4794;
			x4835 = x79;
			x40.backward_filter(x4834, x4835, x4829, x4830, x4831);
			...
			JCudaTensor x4842;
			x4842 = x4807;
			x4837.update(x4842, x4838, x4839);
			...
			JCudaTensor x4849;
			x4849 = x4789;
			x4844.update(x4849, x4845, x4846);
			...
			// val X4354 = X4353 * d_Convolv(1,0)(2a1_cv_W)/d_X8620
			JCudaTensor x4851;
			JCudaTensor x4852, x4853;
			x4852 = x4802;
			x4853 = x38;
			x4851 = x40.backward_data(x4852, x4853);
			...
			JCudaTensor x4860;
			x4860 = x4798;
			x4855.update(x4860, x4856, x4857);
			...
			// val X4370 = X4366 * d_ReLU()(X8629)/d_X8628
			JCudaTensor x4928;
			...
			// val X8464 = X4370 * d_BatchNorm(2a2_b_bn)(X8627,2a2_b_bn_scale)/d_2a2_b_bn_bias
			JCudaTensor x4932;
			...
			// val X8465 = X4370 * d_BatchNorm(2a2_b_bn)(X8627,2a2_b_bn_scale)/d_2a2_b_bn_scale
			JCudaTensor x4937;
			x4937 = x4936[1];

			// val X4371 = X4370 * d_BatchNorm(2a2_b_bn)(X8627,2a2_b_bn_scale)/d_X8627
			JCudaTensor x4941;
			x4941 = x4936[0];
			...
			// val X4372 = X4371 * d_Convolv(1,1)(2a2_b_cv_W)/d_X8626
			JCudaTensor x4953;
			...
			// V_2a2_b_cv_W <~~ X4371 * d_Convolv(1,1)(X8626)/d_2a2_b_cv_W
			float x4957, x4958;
			float x4959;
			float x4960;
			x4959 = 1;
			...
			// val X4376 = X4372 * d_ReLU()(X8626)/d_X8625
			JCudaTensor x5004;
			...
			// val X4377 = X4376 * d_BatchNorm(2a2_a_bn)(X8624,2a2_a_bn_scale)/d_X8624
			JCudaTensor x5008;
			JCudaTensor x5009, x5010, x5011;
			x5009 = x5004;
			x5010 = x41;
			x5011 = x59;
			JCudaTensor[] x5012 = x61.backward(x5009,x5010,x5011);
			x5008 = x5012[0];

			// val X8462 = X4376 * d_BatchNorm(2a2_a_bn)(X8624,2a2_a_bn_scale)/d_2a2_a_bn_scale
			JCudaTensor x5013;
			x5013 = x5012[1];

			// val X8461 = X4376 * d_BatchNorm(2a2_a_bn)(X8624,2a2_a_bn_scale)/d_2a2_a_bn_bias
			JCudaTensor x5017;
			x5017 = x5012[2];
			...
			// val X4379 = (X4354 + X4377 * d_Convolv(1,0)(2a2_a_cv_W)/d_X8620)
			JCudaTensor x5029;
			JCudaTensor x5030;
			x5030 = x4851;
			JCudaTensor x5031, x5032;
			x5031 = x5008;
			x5032 = x45;
			x5029 = x47.backward_data(x5031,x5032, x5030);

			// V_2a2_a_bn_bias <~~ X8461
			float x5034, x5035;
			float x5036;
			float x5037;
			x5036 = 1;
			...
			JCudaTensor x5038;
			x5038 = x5017;
			x5033.update(x5038, x5034, x5035);
			...
			// V_2a2_a_cv_W <~~ X4377 * d_Convolv(1,0)(X8620)/d_2a2_a_cv_W
			float x5041, x5042;
			float x5043;
			float x5044;
			x5043 = 1;
			...
			x5045 = x5008;
			x5046 = x31;
			x47.backward_filter(x5045, x5046, x5040, x5041, x5042);
			...
			JCudaTensor x5080;
			x5080 = x5040;
			x45.update(x5080, x5070, x5071);

			// val X4381 = X4379 * d_Pooling(3,2,0,true)(X8620,X8619)/d_X8619
			JCudaTensor x5081;
			...
			// val X8450 = X4381 * d_ReLU()(X8619)/d_X8618
			JCudaTensor x5087;
			...
			// val X8455 = X8450 * d_BatchNorm(1_bn)(X8617,1_bn_scale)/d_1_bn_bias
			JCudaTensor x5091;
			...
			// val X8451 = X8450 * d_BatchNorm(1_bn)(X8617,1_bn_scale)/d_X8617
			JCudaTensor x5096;
			x5096 = x5095[0];

			// val X8456 = X8450 * d_BatchNorm(1_bn)(X8617,1_bn_scale)/d_1_bn_scale
			JCudaTensor x5100;
			x5100 = x5095[1];
			...
			// V_1_cv_W <~~ X8451 * d_Convolv(2,3)(X8616)/d_1_cv_W
			float x5120, x5121;
			float x5122;
			float x5123;
			x5122 = 1;
	...
	static void test() {
		for(int x5=0; x5<test_itr; x5++) {
			...
			// val X8816 = Convolv(2,3)(X8815,1_cv_W,1_cv_B)
			JCudaTensor x5163;
			...
			// val X8817 = BatchNorm(1_bn)(X8816,1_bn_scale,1_bn_bias)
			JCudaTensor x5168;
			...
			// val X8818 = ReLU()(X8817)
			JCudaTensor x5173;
			JCudaTensor x5174;
			x5174 = x5168;
			x5173 = x30.forward(x5174);

			// val X8819 = Pooling(3,2,0,true)(X8818)
			JCudaTensor x5175;
			JCudaTensor x5176;
			x5176 = x5173;
			...
			// val X8823 = Convolv(1,0)(X8819,2a2_a_cv_W,2a2_a_cv_B)
			JCudaTensor x5178;
			JCudaTensor x5179, x5180, x5181;
			x5179 = x5175;
			x5180 = x45;
			x5181 = x46;
			x5178 = x47.forward(x5179, x5180, x5181);

			// val X8820 = Convolv(1,0)(X8819,2a1_cv_W,2a1_cv_B)
			JCudaTensor x5182;
			JCudaTensor x5183, x5184, x5185;
			x5183 = x5175;
			x5184 = x38;
			x5185 = x39;
			x5182 = x40.forward(x5183, x5184, x5185);
			...
			// val X8821 = BatchNorm(2a1_bn)(X8820,2a1_bn_scale,2a1_bn_bias)
			JCudaTensor x5187;
			...
			// val X8824 = BatchNorm(2a2_a_bn)(X8823,2a2_a_bn_scale,2a2_a_bn_bias)
			JCudaTensor x5192;
			...
			// val X8825 = ReLU()(X8824)
			JCudaTensor x5197;
			JCudaTensor x5198;
			x5198 = x5192;
			x5197 = x64.forward(x5198);

			// val X8826 = Convolv(1,1)(X8825,2a2_b_cv_W,2a2_b_cv_B)
			JCudaTensor x5199;
			...
			// val X8827 = BatchNorm(2a2_b_bn)(X8826,2a2_b_bn_scale,2a2_b_bn_bias)
			JCudaTensor x5204;
			...
			// val X8828 = ReLU()(X8827)
			JCudaTensor x5209;
			JCudaTensor x5210;
			x5210 = x5204;
			x5209 = x64.forward(x5210);

			// val X8829 = Convolv(1,0)(X8828,2a2_c_cv_W,2a2_c_cv_B)
			JCudaTensor x5211;
			JCudaTensor x5212, x5213, x5214;
			x5212 = x5209;
			x5213 = x85;
			x5214 = x86;
			x5211 = x40.forward(x5212, x5213, x5214);
			...
			// val X8830 = BatchNorm(2a2_c_bn)(X8829,2a2_c_bn_scale,2a2_c_bn_bias)
			JCudaTensor x5216;
			...
			// val X8833 = ReLU()(X8832)
			JCudaTensor x5229;
			JCudaTensor x5230;
			x5230 = x5225;
			x5229 = x96.forward(x5230);

			// val X8834 = Convolv(1,0)(X8833,2b_a_cv_W,2b_a_cv_B)
			JCudaTensor x5231;
			...
			// val X8835 = BatchNorm(2b_a_bn)(X8834,2b_a_bn_scale,2b_a_bn_bias)
			JCudaTensor x5235;
			...
			// val X8836 = ReLU()(X8835)
			JCudaTensor x5240;
			JCudaTensor x5241;
			x5241 = x5235;
			x5240 = x64.forward(x5241);

			// val X8837 = Convolv(1,1)(X8836,2b_b_cv_W,2b_b_cv_B)
			JCudaTensor x5242;
			...
			// val X8838 = BatchNorm(2b_b_bn)(X8837,2b_b_bn_scale,2b_b_bn_bias)
			JCudaTensor x5247;
			...
			// val X8839 = ReLU()(X8838)
			JCudaTensor x5252;
			JCudaTensor x5253;
			x5253 = x5247;
			x5252 = x64.forward(x5253);

			// val X8840 = Convolv(1,0)(X8839,2b_c_cv_W,2b_c_cv_B)
			JCudaTensor x5254;
			JCudaTensor x5255, x5256, x5257;
			x5255 = x5252;
			x5256 = x139;
			x5257 = x140;
			x5254 = x40.forward(x5255, x5256, x5257);
			...
			// val X8841 = BatchNorm(2b_c_bn)(X8840,2b_c_bn_scale,2b_c_bn_bias)
			JCudaTensor x5259;
			...
			// val X8844 = ReLU()(X8843)
			JCudaTensor x5270;
			JCudaTensor x5271;
			x5271 = x5266;
			x5270 = x96.forward(x5271);

			// val X8845 = Convolv(1,0)(X8844,2c_a_cv_W,2c_a_cv_B)
			JCudaTensor x5272;
			...
			// val X8846 = BatchNorm(2c_a_bn)(X8845,2c_a_bn_scale,2c_a_bn_bias)
			JCudaTensor x5276;
			...
			// val X8847 = ReLU()(X8846)
			JCudaTensor x5281;
			JCudaTensor x5282;
			x5282 = x5276;
			x5281 = x64.forward(x5282);

			// val X8848 = Convolv(1,1)(X8847,2c_b_cv_W,2c_b_cv_B)
			JCudaTensor x5283;
			...
			// val X8849 = BatchNorm(2c_b_bn)(X8848,2c_b_bn_scale,2c_b_bn_bias)
			JCudaTensor x5288;
			...
			// val X8850 = ReLU()(X8849)
			JCudaTensor x5293;
			JCudaTensor x5294;
			x5294 = x5288;
			x5293 = x64.forward(x5294);

			// val X8851 = Convolv(1,0)(X8850,2c_c_cv_W,2c_c_cv_B)
			JCudaTensor x5295;
			JCudaTensor x5296, x5297, x5298;
			x5296 = x5293;
			x5297 = x189;
			x5298 = x190;
			x5295 = x40.forward(x5296, x5297, x5298);
			...
			// val X8852 = BatchNorm(2c_c_bn)(X8851,2c_c_bn_scale,2c_c_bn_bias)
			JCudaTensor x5300;
			...
			// val X8855 = ReLU()(X8854)
			JCudaTensor x5311;
			JCudaTensor x5312;
			x5312 = x5307;
			x5311 = x96.forward(x5312);

			// val X8856 = Convolv(2,0)(X8855,3a1_cv_W,3a1_cv_B)
			JCudaTensor x5313;
			JCudaTensor x5314, x5315, x5316;
			x5314 = x5311;
			x5315 = x209;
			x5316 = x210;
			x5313 = x211.forward(x5314, x5315, x5316);

			// val X8859 = Convolv(2,0)(X8855,3a2_a_cv_W,3a2_a_cv_B)
			JCudaTensor x5317;
			JCudaTensor x5318, x5319, x5320;
			x5318 = x5311;
			x5319 = x216;
			x5320 = x217;
			x5317 = x218.forward(x5318, x5319, x5320);
			...
			// val X8860 = BatchNorm(3a2_a_bn)(X8859,3a2_a_bn_scale,3a2_a_bn_bias)
			JCudaTensor x5322;
			...
			// val X8857 = BatchNorm(3a1_bn)(X8856,3a1_bn_scale,3a1_bn_bias)
			JCudaTensor x5327;
			...
			// val X8861 = ReLU()(X8860)
			JCudaTensor x5332;
			JCudaTensor x5333;
			x5333 = x5322;
			x5332 = x235.forward(x5333);

			// val X8862 = Convolv(1,1)(X8861,3a2_b_cv_W,3a2_b_cv_B)
			JCudaTensor x5334;
			...
			// val X8863 = BatchNorm(3a2_b_bn)(X8862,3a2_b_bn_scale,3a2_b_bn_bias)
			JCudaTensor x5339;
			...
			// val X8864 = ReLU()(X8863)
			JCudaTensor x5344;
			JCudaTensor x5345;
			x5345 = x5339;
			x5344 = x235.forward(x5345);

			// val X8865 = Convolv(1,0)(X8864,3a2_c_cv_W,3a2_c_cv_B)
			JCudaTensor x5346;
			...
			// val X8866 = BatchNorm(3a2_c_bn)(X8865,3a2_c_bn_scale,3a2_c_bn_bias)
			JCudaTensor x5351;
			...
			// val X8869 = ReLU()(X8868)
			JCudaTensor x5364;
			JCudaTensor x5365;
			x5365 = x5360;
			x5364 = x268.forward(x5365);

			// val X8870 = Convolv(1,0)(X8869,3b_a_cv_W,3b_a_cv_B)
			JCudaTensor x5366;
			...
			// val X8871 = BatchNorm(3b_a_bn)(X8870,3b_a_bn_scale,3b_a_bn_bias)
			JCudaTensor x5370;
			...
			// val X8872 = ReLU()(X8871)
			JCudaTensor x5375;
			JCudaTensor x5376;
			x5376 = x5370;
			x5375 = x235.forward(x5376);

			// val X8873 = Convolv(1,1)(X8872,3b_b_cv_W,3b_b_cv_B)
			JCudaTensor x5377;
			...
			// val X8874 = BatchNorm(3b_b_bn)(X8873,3b_b_bn_scale,3b_b_bn_bias)
			JCudaTensor x5382;
			...
			// val X8875 = ReLU()(X8874)
			JCudaTensor x5387;
			JCudaTensor x5388;
			x5388 = x5382;
			x5387 = x235.forward(x5388);

			// val X8876 = Convolv(1,0)(X8875,3b_c_cv_W,3b_c_cv_B)
			JCudaTensor x5389;
			...
			// val X8877 = BatchNorm(3b_c_bn)(X8876,3b_c_bn_scale,3b_c_bn_bias)
			JCudaTensor x5394;
			...
			// val X8880 = ReLU()(X8879)
			JCudaTensor x5405;
			JCudaTensor x5406;
			x5406 = x5401;
			x5405 = x268.forward(x5406);

			// val X8881 = Convolv(1,0)(X8880,3c_a_cv_W,3c_a_cv_B)
			JCudaTensor x5407;
			...
			// val X8882 = BatchNorm(3c_a_bn)(X8881,3c_a_bn_scale,3c_a_bn_bias)
			JCudaTensor x5411;
			...
			// val X8883 = ReLU()(X8882)
			JCudaTensor x5416;
			JCudaTensor x5417;
			x5417 = x5411;
			x5416 = x235.forward(x5417);

			// val X8884 = Convolv(1,1)(X8883,3c_b_cv_W,3c_b_cv_B)
			JCudaTensor x5418;
			...
			// val X8885 = BatchNorm(3c_b_bn)(X8884,3c_b_bn_scale,3c_b_bn_bias)
			JCudaTensor x5423;
			...
			// val X8886 = ReLU()(X8885)
			JCudaTensor x5428;
			JCudaTensor x5429;
			x5429 = x5423;
			x5428 = x235.forward(x5429);

			// val X8887 = Convolv(1,0)(X8886,3c_c_cv_W,3c_c_cv_B)
			JCudaTensor x5430;
			...
			// val X8888 = BatchNorm(3c_c_bn)(X8887,3c_c_bn_scale,3c_c_bn_bias)
			JCudaTensor x5435;
			...
			// val X8891 = ReLU()(X8890)
			JCudaTensor x5446;
			JCudaTensor x5447;
			x5447 = x5442;
			x5446 = x268.forward(x5447);

			// val X8892 = Convolv(1,0)(X8891,3d_a_cv_W,3d_a_cv_B)
			JCudaTensor x5448;
			...
			// val X8893 = BatchNorm(3d_a_bn)(X8892,3d_a_bn_scale,3d_a_bn_bias)
			JCudaTensor x5452;
			...
			// val X8894 = ReLU()(X8893)
			JCudaTensor x5457;
			JCudaTensor x5458;
			x5458 = x5452;
			x5457 = x235.forward(x5458);

			// val X8895 = Convolv(1,1)(X8894,3d_b_cv_W,3d_b_cv_B)
			JCudaTensor x5459;
			...
			// val X8896 = BatchNorm(3d_b_bn)(X8895,3d_b_bn_scale,3d_b_bn_bias)
			JCudaTensor x5464;
			...
			// val X8897 = ReLU()(X8896)
			JCudaTensor x5469;
			JCudaTensor x5470;
			x5470 = x5464;
			x5469 = x235.forward(x5470);

			// val X8898 = Convolv(1,0)(X8897,3d_c_cv_W,3d_c_cv_B)
			JCudaTensor x5471;
			...
			// val X8899 = BatchNorm(3d_c_bn)(X8898,3d_c_bn_scale,3d_c_bn_bias)
			JCudaTensor x5476;
			...
			// val X8902 = ReLU()(X8901)
			JCudaTensor x5487;
			JCudaTensor x5488;
			x5488 = x5483;
			x5487 = x268.forward(x5488);

			// val X8903 = Convolv(2,0)(X8902,4a1_cv_W,4a1_cv_B)
			JCudaTensor x5489;
			JCudaTensor x5490, x5491, x5492;
			x5490 = x5487;
			x5491 = x431;
			x5492 = x432;
			x5489 = x433.forward(x5490, x5491, x5492);

			// val X8906 = Convolv(2,0)(X8902,4a2_a_cv_W,4a2_a_cv_B)
			JCudaTensor x5493;
			JCudaTensor x5494, x5495, x5496;
			x5494 = x5487;
			x5495 = x438;
			x5496 = x439;
			x5493 = x440.forward(x5494, x5495, x5496);
			...
			// val X8907 = BatchNorm(4a2_a_bn)(X8906,4a2_a_bn_scale,4a2_a_bn_bias)
			JCudaTensor x5498;
			JCudaTensor x5499, x5500, x5501;
			x5499 = x5493;
			x5500 = x445;
			x5501 = x446;
			x5498 = x447.forward_inference(x5499, x5500, x5501);
			...
			// val X8904 = BatchNorm(4a1_bn)(X8903,4a1_bn_scale,4a1_bn_bias)
			JCudaTensor x5503;
			JCudaTensor x5504, x5505, x5506;
			x5504 = x5489;
			x5505 = x452;
			x5506 = x453;
			x5503 = x454.forward_inference(x5504, x5505, x5506);
			...
			// val X8908 = ReLU()(X8907)
			JCudaTensor x5508;
			JCudaTensor x5509;
			x5509 = x5498;
			x5508 = x457.forward(x5509);

			// val X8909 = Convolv(1,1)(X8908,4a2_b_cv_W,4a2_b_cv_B)
			JCudaTensor x5510;
			...
			// val X8910 = BatchNorm(4a2_b_bn)(X8909,4a2_b_bn_scale,4a2_b_bn_bias)
			JCudaTensor x5515;
			...
			// val X8911 = ReLU()(X8910)
			JCudaTensor x5520;
			JCudaTensor x5521;
			x5521 = x5515;
			x5520 = x457.forward(x5521);

			// val X8912 = Convolv(1,0)(X8911,4a2_c_cv_W,4a2_c_cv_B)
			JCudaTensor x5522;
			...
			// val X8913 = BatchNorm(4a2_c_bn)(X8912,4a2_c_bn_scale,4a2_c_bn_bias)
			JCudaTensor x5527;
			...
			// val X8916 = ReLU()(X8915)
			JCudaTensor x5540;
			JCudaTensor x5541;
			x5541 = x5536;
			x5540 = x490.forward(x5541);

			// val X8917 = Convolv(1,0)(X8916,4b_a_cv_W,4b_a_cv_B)
			JCudaTensor x5542;
			...
			// val X8918 = BatchNorm(4b_a_bn)(X8917,4b_a_bn_scale,4b_a_bn_bias)
			JCudaTensor x5546;
			...
			// val X8919 = ReLU()(X8918)
			JCudaTensor x5551;
			JCudaTensor x5552;
			x5552 = x5546;
			x5551 = x457.forward(x5552);

			// val X8920 = Convolv(1,1)(X8919,4b_b_cv_W,4b_b_cv_B)
			JCudaTensor x5553;
			...
			// val X8921 = BatchNorm(4b_b_bn)(X8920,4b_b_bn_scale,4b_b_bn_bias)
			JCudaTensor x5558;
			...
			// val X8922 = ReLU()(X8921)
			JCudaTensor x5563;
			JCudaTensor x5564;
			x5564 = x5558;
			x5563 = x457.forward(x5564);

			// val X8923 = Convolv(1,0)(X8922,4b_c_cv_W,4b_c_cv_B)
			JCudaTensor x5565;
			...
			// val X8924 = BatchNorm(4b_c_bn)(X8923,4b_c_bn_scale,4b_c_bn_bias)
			JCudaTensor x5570;
			...
			// val X8927 = ReLU()(X8926)
			JCudaTensor x5581;
			JCudaTensor x5582;
			x5582 = x5577;
			x5581 = x490.forward(x5582);

			// val X8928 = Convolv(1,0)(X8927,4c_a_cv_W,4c_a_cv_B)
			JCudaTensor x5583;
			...
			// val X8929 = BatchNorm(4c_a_bn)(X8928,4c_a_bn_scale,4c_a_bn_bias)
			JCudaTensor x5587;
			...
			// val X8930 = ReLU()(X8929)
			JCudaTensor x5592;
			JCudaTensor x5593;
			x5593 = x5587;
			x5592 = x457.forward(x5593);

			// val X8931 = Convolv(1,1)(X8930,4c_b_cv_W,4c_b_cv_B)
			JCudaTensor x5594;
			...
			// val X8932 = BatchNorm(4c_b_bn)(X8931,4c_b_bn_scale,4c_b_bn_bias)
			JCudaTensor x5599;
			...
			// val X8933 = ReLU()(X8932)
			JCudaTensor x5604;
			JCudaTensor x5605;
			x5605 = x5599;
			x5604 = x457.forward(x5605);

			// val X8934 = Convolv(1,0)(X8933,4c_c_cv_W,4c_c_cv_B)
			JCudaTensor x5606;
			...
			// val X8935 = BatchNorm(4c_c_bn)(X8934,4c_c_bn_scale,4c_c_bn_bias)
			JCudaTensor x5611;
			...
			// val X8938 = ReLU()(X8937)
			JCudaTensor x5622;
			JCudaTensor x5623;
			x5623 = x5618;
			x5622 = x490.forward(x5623);

			// val X8939 = Convolv(1,0)(X8938,4d_a_cv_W,4d_a_cv_B)
			JCudaTensor x5624;
			...
			// val X8940 = BatchNorm(4d_a_bn)(X8939,4d_a_bn_scale,4d_a_bn_bias)
			JCudaTensor x5628;
			...
			// val X8941 = ReLU()(X8940)
			JCudaTensor x5633;
			JCudaTensor x5634;
			x5634 = x5628;
			x5633 = x457.forward(x5634);

			// val X8942 = Convolv(1,1)(X8941,4d_b_cv_W,4d_b_cv_B)
			JCudaTensor x5635;
			...
			// val X8943 = BatchNorm(4d_b_bn)(X8942,4d_b_bn_scale,4d_b_bn_bias)
			JCudaTensor x5640;
			...
			// val X8944 = ReLU()(X8943)
			JCudaTensor x5645;
			JCudaTensor x5646;
			x5646 = x5640;
			x5645 = x457.forward(x5646);

			// val X8945 = Convolv(1,0)(X8944,4d_c_cv_W,4d_c_cv_B)
			JCudaTensor x5647;
			...
			// val X8946 = BatchNorm(4d_c_bn)(X8945,4d_c_bn_scale,4d_c_bn_bias)
			JCudaTensor x5652;
			...
			// val X8949 = ReLU()(X8948)
			JCudaTensor x5663;
			JCudaTensor x5664;
			x5664 = x5659;
			x5663 = x490.forward(x5664);

			// val X8950 = Convolv(1,0)(X8949,4e_a_cv_W,4e_a_cv_B)
			JCudaTensor x5665;
			...
			// val X8951 = BatchNorm(4e_a_bn)(X8950,4e_a_bn_scale,4e_a_bn_bias)
			JCudaTensor x5669;
			...
			// val X8952 = ReLU()(X8951)
			JCudaTensor x5674;
			JCudaTensor x5675;
			x5675 = x5669;
			x5674 = x457.forward(x5675);

			// val X8953 = Convolv(1,1)(X8952,4e_b_cv_W,4e_b_cv_B)
			JCudaTensor x5676;
			...
			// val X8954 = BatchNorm(4e_b_bn)(X8953,4e_b_bn_scale,4e_b_bn_bias)
			JCudaTensor x5681;
			...
			// val X8955 = ReLU()(X8954)
			JCudaTensor x5686;
			JCudaTensor x5687;
			x5687 = x5681;
			x5686 = x457.forward(x5687);

			// val X8956 = Convolv(1,0)(X8955,4e_c_cv_W,4e_c_cv_B)
			JCudaTensor x5688;
			...
			// val X8957 = BatchNorm(4e_c_bn)(X8956,4e_c_bn_scale,4e_c_bn_bias)
			JCudaTensor x5693;
			...
			// val X8960 = ReLU()(X8959)
			JCudaTensor x5704;
			JCudaTensor x5705;
			x5705 = x5700;
			x5704 = x490.forward(x5705);

			// val X8961 = Convolv(1,0)(X8960,4f_a_cv_W,4f_a_cv_B)
			JCudaTensor x5706;
			...
			// val X8962 = BatchNorm(4f_a_bn)(X8961,4f_a_bn_scale,4f_a_bn_bias)
			JCudaTensor x5710;
			...
			// val X8963 = ReLU()(X8962)
			JCudaTensor x5715;
			JCudaTensor x5716;
			x5716 = x5710;
			x5715 = x457.forward(x5716);

			// val X8964 = Convolv(1,1)(X8963,4f_b_cv_W,4f_b_cv_B)
			JCudaTensor x5717;
			...
			// val X8965 = BatchNorm(4f_b_bn)(X8964,4f_b_bn_scale,4f_b_bn_bias)
			JCudaTensor x5722;
			...
			// val X8966 = ReLU()(X8965)
			JCudaTensor x5727;
			JCudaTensor x5728;
			x5728 = x5722;
			x5727 = x457.forward(x5728);

			// val X8967 = Convolv(1,0)(X8966,4f_c_cv_W,4f_c_cv_B)
			JCudaTensor x5729;
			...
			// val X8968 = BatchNorm(4f_c_bn)(X8967,4f_c_bn_scale,4f_c_bn_bias)
			JCudaTensor x5734;
			...
			// val X8971 = ReLU()(X8970)
			JCudaTensor x5745;
			JCudaTensor x5746;
			x5746 = x5741;
			x5745 = x490.forward(x5746);

			// val X8972 = Convolv(2,0)(X8971,5a1_cv_W,5a1_cv_B)
			JCudaTensor x5747;
			JCudaTensor x5748, x5749, x5750;
			x5748 = x5745;
			x5749 = x753;
			x5750 = x754;
			x5747 = x755.forward(x5748, x5749, x5750);

			// val X8975 = Convolv(2,0)(X8971,5a2_a_cv_W,5a2_a_cv_B)
			JCudaTensor x5751;
			JCudaTensor x5752, x5753, x5754;
			x5752 = x5745;
			x5753 = x760;
			x5754 = x761;
			x5751 = x762.forward(x5752, x5753, x5754);
			...
			// val X8976 = BatchNorm(5a2_a_bn)(X8975,5a2_a_bn_scale,5a2_a_bn_bias)
			JCudaTensor x5756;
			...
			// val X8973 = BatchNorm(5a1_bn)(X8972,5a1_bn_scale,5a1_bn_bias)
			JCudaTensor x5761;
			...
			// val X8977 = ReLU()(X8976)
			JCudaTensor x5766;
			JCudaTensor x5767;
			x5767 = x5756;
			x5766 = x779.forward(x5767);

			// val X8978 = Convolv(1,1)(X8977,5a2_b_cv_W,5a2_b_cv_B)
			JCudaTensor x5768;
			...
			// val X8979 = BatchNorm(5a2_b_bn)(X8978,5a2_b_bn_scale,5a2_b_bn_bias)
			JCudaTensor x5773;
			...
			// val X8980 = ReLU()(X8979)
			JCudaTensor x5778;
			JCudaTensor x5779;
			x5779 = x5773;
			x5778 = x779.forward(x5779);

			// val X8981 = Convolv(1,0)(X8980,5a2_c_cv_W,5a2_c_cv_B)
			JCudaTensor x5780;
			...
			// val X8982 = BatchNorm(5a2_c_bn)(X8981,5a2_c_bn_scale,5a2_c_bn_bias)
			JCudaTensor x5785;
			...
			// val X8985 = ReLU()(X8984)
			JCudaTensor x5798;
			JCudaTensor x5799;
			x5799 = x5794;
			x5798 = x812.forward(x5799);

			// val X8986 = Convolv(1,0)(X8985,5b_a_cv_W,5b_a_cv_B)
			JCudaTensor x5800;
			...
			// val X8987 = BatchNorm(5b_a_bn)(X8986,5b_a_bn_scale,5b_a_bn_bias)
			JCudaTensor x5804;
			...
			// val X8988 = ReLU()(X8987)
			JCudaTensor x5809;
			JCudaTensor x5810;
			x5810 = x5804;
			x5809 = x779.forward(x5810);

			// val X8989 = Convolv(1,1)(X8988,5b_b_cv_W,5b_b_cv_B)
			JCudaTensor x5811;
			...
			// val X8990 = BatchNorm(5b_b_bn)(X8989,5b_b_bn_scale,5b_b_bn_bias)
			JCudaTensor x5816;
			...
			// val X8991 = ReLU()(X8990)
			JCudaTensor x5821;
			JCudaTensor x5822;
			x5822 = x5816;
			x5821 = x779.forward(x5822);

			// val X8992 = Convolv(1,0)(X8991,5b_c_cv_W,5b_c_cv_B)
			JCudaTensor x5823;
			...
			// val X8993 = BatchNorm(5b_c_bn)(X8992,5b_c_bn_scale,5b_c_bn_bias)
			JCudaTensor x5828;
			...
			// val X8996 = ReLU()(X8995)
			JCudaTensor x5839;
			JCudaTensor x5840;
			x5840 = x5835;
			x5839 = x812.forward(x5840);

			// val X8997 = Convolv(1,0)(X8996,5c_a_cv_W,5c_a_cv_B)
			JCudaTensor x5841;
			...
			// val X8998 = BatchNorm(5c_a_bn)(X8997,5c_a_bn_scale,5c_a_bn_bias)
			JCudaTensor x5845;
			...
			// val X8999 = ReLU()(X8998)
			JCudaTensor x5850;
			JCudaTensor x5851;
			x5851 = x5845;
			x5850 = x779.forward(x5851);

			// val X9000 = Convolv(1,1)(X8999,5c_b_cv_W,5c_b_cv_B)
			JCudaTensor x5852;
			...
			// val X9001 = BatchNorm(5c_b_bn)(X9000,5c_b_bn_scale,5c_b_bn_bias)
			JCudaTensor x5857;
			...
			// val X9002 = ReLU()(X9001)
			JCudaTensor x5862;
			JCudaTensor x5863;
			x5863 = x5857;
			x5862 = x779.forward(x5863);

			// val X9003 = Convolv(1,0)(X9002,5c_c_cv_W,5c_c_cv_B)
			JCudaTensor x5864;
			...
			// val X9004 = BatchNorm(5c_c_bn)(X9003,5c_c_bn_scale,5c_c_bn_bias)
			JCudaTensor x5869;
			...
			// val X9007 = ReLU()(X9006)
			JCudaTensor x5880;
			JCudaTensor x5881;
			x5881 = x5876;
			x5880 = x812.forward(x5881);

			// val X9008 = Pooling(7,1,0,false)(X9007)
			JCudaTensor x5882;
			JCudaTensor x5883;
			x5883 = x5880;
			...
			// val X9009 = (X9008[1><3])(i1 | @) * (fc_W)(i2 | @)
			JCudaTensor x5885;
			JCudaMatrix x5886;
			JCudaMatrix x5887;
			JCudaTensor x5888;
		...
		System.out.println();
		System.out.println("average precision: " + x5895/test_itr);
		System.out.println(); 
	}
